...
def test_pdms():
    ...
    ref_opdm = psi4.core.Matrix.from_array(
        [
            np.array(
                [
                    [9.84317436e-01, 4.69564137e-03, 3.68310242e-03],
            ...
            np.array(
                [
                    [0.00416892, 0.00440128, 0.00073837],
    ...
    ref_tdm = psi4.core.Matrix.from_array(
        [
            np.array(
                [
                    [1.11543287e-02, 6.66837005e-02, -9.01185592e-03],
            ...
            np.array(
                [
                    [-0.0436292, -0.01418167, -0.00124078],
    ...
    assert psi4.compare_matrices(
        wfn.get_opdm(2, 1, "A", True), wfn.get_opdm(1, 2, "A", True).transpose(), 6, "TDM SWAP"
    )
