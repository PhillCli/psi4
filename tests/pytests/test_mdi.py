...
def test_mdi_water():
    ...
    assert compare_values(expected, charges, atol=1.0e-7)
    ...
    expected = [
        0.004473733542292732,
        -0.01775852359379196,
        -0.051757651796320636,
        -0.0016762687719661835,
        -0.024093270269019917,
        0.019393138772564877,
        -0.0027974647702799747,
        0.04185179386282589,
        0.03236451302360538,
    ]
    ...
    assert compare_values(expected, dimensions, atol=1.0e-7)
