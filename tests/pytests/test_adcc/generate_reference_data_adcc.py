...
if __name__ == "__main__":
    ...
    configs = [
        AdccConfig(
            "adc(1)", "cc-pvdz", molecules["cn"], "cn", n_states=4, kind="any", reference="uhf", label="quick"
        ),  # cn-adc1
        AdccConfig("adc(2)", "cc-pvdz", molecules["cn"], "cn", n_states=6, kind="any", reference="uhf"),  # cn-adc2
        AdccConfig(
            "adc(1)", "cc-pvdz", molecules["h2o"], "h2o", n_states=10, kind="singlet", label="quick"
        ),  # h2o-adc1
        AdccConfig("adc(2)", "cc-pvdz", molecules["h2o"], "h2o", n_states=10, kind="singlet"),  # h2o-adc2
        AdccConfig(
            "adc(1)", "cc-pvdz", molecules["h2o"], "h2o", n_states=2, kind="singlet", label="quick"
        ),  # h2o-adc1-quick
        ...
        AdccConfig(
            "cvs-adc(1)", "cc-pvdz", molecules["h2o"], "h2o", n_states=10, kind="singlet", core_orbitals=1
        ),  # h2o-cvs-adc1
        AdccConfig(
            "cvs-adc(2)", "cc-pvdz", molecules["h2o"], "h2o", n_states=10, kind="singlet", core_orbitals=1
        ),  # h2o-cvs-adc2
        AdccConfig(
            "cvs-adc(2)-x", "cc-pvdz", molecules["h2o"], "h2o", n_states=10, kind="singlet", core_orbitals=1
        ),  # h2o-cvs-adc2x
        AdccConfig(
            "cvs-adc(2)-x",
            "cc-pvdz",
            ...
            core_orbitals=1,
            label="quick",
        ),  # h2o-cvs-adc2x-triplets
        AdccConfig(
            "cvs-adc(3)", "cc-pvdz", molecules["h2o"], "h2o", n_states=10, kind="singlet", core_orbitals=1
        ),  # h2o-cvs-adc3
        AdccConfig(
            "adc(2)", "cc-pvdz", molecules["h2o"], "h2o", n_states=5, kind="singlet", frozen_core=True, label="quick"
        ),  # h2o-fc-adc2
        AdccConfig(
            "adc(2)-x", "cc-pvdz", molecules["h2o"], "h2o", n_states=5, kind="singlet", frozen_virtual=5, label="quick"
        ),  # h2o-fv-adc2x
        AdccConfig(
            "adc(2)", "6-31G", molecules["hf"], "hf", n_states=5, kind="spin_flip", reference="uhf"
        ),  # hf-adc2-spin-flip
        AdccConfig(
            "adc(2)",
            "sto-3g",
