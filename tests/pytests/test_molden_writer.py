...
from psi4.driver.p4util.testing import compare_integers, compare_strings, compare_values
        ...
        pytest.param(
            {
                ...
                "do_virtual": True,
                "use_natural": True,
                "options": {"e_convergence": 10, "qc_module": "detci", "opdm": True},
            },
            id="orbso_detci",
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            {"name": "orbso_density", "energy": "ccsd", "do_virtual": True, "use_natural": True}, id="orbso_density"
        ),
    ],
)
def test_H2O_density_molden(inp_h2o_density, datadir):
    mol = psi4.geometry("""
            ...
            H   1   0.951342   2   112.505645
            """)
    psi4.set_options({"basis": "dz", "scf_type": "pk", "e_convergence": 10})
...
def test_OH_molden(inp_oh, datadir):
    mol = psi4.geometry("""
            ...
            symmetry c1
            """)
    psi4.set_options({"basis": "dz", "scf_type": "pk", "e_convergence": 11, "reference": inp_oh["ref"]})
...
def test_H2S_molden(inp_h2s, datadir):
    mol = psi4.geometry("""
            ...
            """)
    psi4.set_options({"scf_type": "pk", "e_convergence": 10})
...
def test_ClFHCOH_molden(inp_clfhcoh, datadir):
    mol = psi4.geometry("""
            ...
            """)
    psi4.set_options({"basis": "dz", "scf_type": "pk", "e_convergence": 11})
