...
_tot_cp_grad = np.array(
    [
        [-0.0, 0.003989481299, 0.000257671876],
        [0.0, -0.003989481299, 0.000257671876],
        [-0.007206301768, 0.004333142371, 0.000029433226],
        [0.007206301768, 0.004333142371, 0.000029433226],
        [0.007206301768, -0.004333142371, 0.000029433226],
        [-0.007206301768, -0.004333142371, 0.000029433226],
        [-0.0, -0.0, -0.035555548002],
        [-0.0, 0.0, 0.035547129205],
        [0.0, -0.0, 0.00840988492],
        [0.0, 0.0, -0.009034542779],
    ]
)
_ie_cp_grad = np.array(
    [
        [-0.0, 0.000831523566, 0.000095334214],
        [0.0, -0.000831523566, 0.000095334214],
        [-0.00011127085, 0.000096261386, 0.000110602057],
        [0.00011127085, 0.000096261386, 0.000110602057],
        [0.00011127085, -0.000096261386, 0.000110602057],
        [-0.00011127085, -0.000096261386, 0.000110602057],
        [-0.0, 0.0, -0.00139615575],
        [-0.0, 0.0, -0.000684195246],
        [0.0, 0.0, 0.001393980177],
        [0.0, 0.0, 0.000053294161],
    ]
)
_tot_uncp_grad = np.array(
    [
        [-0.0, 0.004688102439, 0.000019589414],
        [0.0, -0.004688102439, 0.000019589414],
        [-0.007232900028, 0.004303778033, 0.000005580357],
        [0.007232900028, 0.004303778033, 0.000005580357],
        [0.007232900028, -0.004303778033, 0.000005580357],
        [-0.007232900028, -0.004303778033, 0.000005580357],
        [-0.0, 0.0, -0.035419642667],
        [-0.0, 0.0, 0.03585801241],
        [0.0, 0.0, 0.008543047852],
        [0.0, 0.0, -0.009042917851],
    ]
)
_ie_uncp_grad = np.array(
    [
        [-0.0, 0.001530144706, -0.000142748248],
        [0.0, -0.001530144706, -0.000142748248],
        [-0.00013786911, 0.000066897048, 0.000086749188],
        [0.00013786911, 0.000066897048, 0.000086749188],
        [0.00013786911, -0.000066897048, 0.000086749188],
        [-0.00013786911, -0.000066897048, 0.000086749188],
        [-0.0, 0.0, -0.001260250416],
        [-0.0, -0.0, -0.000373312041],
        [0.0, 0.0, 0.00152714311],
        [0.0, 0.0, 0.000044919089],
    ]
)
...
""")
    ...
    assert compare_values(return_result, ret.return_result, atol=1.0e-6, label="manybody")
