...
def test_comprehensive_jk_screening(scf_type, scf_subtype, screening):
    ...
    Eref = {
        ...
        "Singlet": {
            ...
            "Composite": {"DFDIRJ+COSX": -149.58722317236171, "DFDIRJ+LINK": -149.58726772171027},
        },
    }
    ...
    if should_throw:
        ...
        assert compare(
            type(e_info), pytest.ExceptionInfo, f"Singlet {scf_type}({scf_subtype})+{screening}  throws exception"
        )
