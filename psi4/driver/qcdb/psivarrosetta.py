...
useme2psivar = {
    ...
    'dsdpbep86.usemeraw':
    'DSD-PBEP86 TOTAL ENERGY',  # no psivar for fctl + dh, which would be the more restrictive def  # also DSD technically implies -D
...
optclue2psivar = {
    'full': [
        'CCSD CORRELATION ENERGY', 'CCSD TOTAL ENERGY', 'CCSD(T) TOTAL ENERGY', 'CCSD(T) CORRELATION ENERGY',
        '(T) CORRECTION ENERGY', 'CCSDT TOTAL ENERGY', 'CCSDT CORRELATION ENERGY', 'CCSDT(Q) TOTAL ENERGY',
        'CCSDT(Q) CORRELATION ENERGY', '(Q) CORRECTION ENERGY'
    ],
    'fno1e3': [
        'CCSD(T) FNO CORRELATION ENERGY', 'CCSD FNO CORRELATION ENERGY', 'MP3 FNO CORRELATION ENERGY',
        'FNO CORRECTION ENERGY', 'CCSD CORRELATION ENERGY', 'CCSD TOTAL ENERGY', 'CCSD(T) TOTAL ENERGY',
        'CCSD(T) CORRELATION ENERGY', '(T) CORRECTION ENERGY', 'CCSDT TOTAL ENERGY', 'CCSDT CORRELATION ENERGY',
    ...
    'mrcc': [
        'CCSD CORRELATION ENERGY', 'CCSD(T) CORRELATION ENERGY', '(T) CORRECTION ENERGY', 'CCSDT CORRELATION ENERGY',
        'CCSDT(Q) CORRELATION ENERGY', '(Q) CORRECTION ENERGY'
    ],
    'nfc': [
        'B2PLYP TOTAL ENERGY', 'B2PLYP-D2 TOTAL ENERGY', 'B2PLYP-D3 TOTAL ENERGY', 'B2PLYP-D3(BJ) TOTAL ENERGY',
        'B2PLYP-D3M TOTAL ENERGY', 'B2PLYP-D3M(BJ) TOTAL ENERGY', 'DSD-PBEP86 TOTAL ENERGY',
        'DSD-PBEP86-D2 TOTAL ENERGY', 'DSD-PBEP86-D3 TOTAL ENERGY', 'DSD-PBEP86-D3(BJ) TOTAL ENERGY',
    ...
    'dfhf': [
        ...
        'SCS-MP2-F12 TOTAL ENERGY',
        'SCS(N)-MP2-F12 TOTAL ENERGY',
        'SCS(MI)-MP2-F12 TOTAL ENERGY',
        'DW-MP2-F12 TOTAL ENERGY',
        'MP2C-F12 TOTAL ENERGY',
        'SCF TOTAL ENERGY',
        'HF TOTAL ENERGY',
        'MP2 TOTAL ENERGY',
        'SCS-MP2 TOTAL ENERGY',
        'SCS(N)-MP2 TOTAL ENERGY',
        'SCS(MI)-MP2 TOTAL ENERGY',
        'DW-MP2 TOTAL ENERGY',
        'MP2C TOTAL ENERGY',
        ...
        'M05-2X FUNCTIONAL TOTAL ENERGY',
        'M05-2X TOTAL ENERGY',
    ...
    'dfmp': [
        ...
        'SCS-MP2-F12 CORRELATION ENERGY',
        'SCS-MP2-F12 TOTAL ENERGY',
        'SCS(N)-MP2-F12 CORRELATION ENERGY',
        'SCS(N)-MP2-F12 TOTAL ENERGY',
        'SCS(MI)-MP2-F12 CORRELATION ENERGY',
        'SCS(MI)-MP2-F12 TOTAL ENERGY',
        'DW-MP2-F12 CORRELATION ENERGY',
        'DW-MP2-F12 TOTAL ENERGY',
        'MP2C-F12 CORRELATION ENERGY',
        'MP2C-F12 TOTAL ENERGY',
        ...
        'SCS(N)-MP2 TOTAL ENERGY',
        'SCS(MI)-MP2 CORRELATION ENERGY',
        'SCS(MI)-MP2 TOTAL ENERGY',
        'DW-MP2 CORRELATION ENERGY',
        'DW-MP2 TOTAL ENERGY',
        'MP2C CORRELATION ENERGY',
        'MP2C TOTAL ENERGY',
