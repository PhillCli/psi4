...
def load_basfam_dunning():
    ...
    basis_ccpwcvdz.add_jkfit("cc-pVDZ-JKFIT")
    basis_ccpwcv_dpd_z.add_jkfit("cc-pVDZ-JKFIT")
    basis_augccpwcvdz.add_jkfit("aug-cc-pVDZ-JKFIT")
    basis_augccpwcv_dpd_z.add_jkfit("aug-cc-pVDZ-JKFIT")
    basis_heavyaugccpwcvdz.add_jkfit("heavy-aug-cc-pVDZ-JKFIT")
    basis_heavyaugccpwcv_dpd_z.add_jkfit("heavy-aug-cc-pVDZ-JKFIT")
    basis_junccpwcvdz.add_jkfit("jun-cc-pVDZ-JKFIT")
    basis_junccpwcv_dpd_z.add_jkfit("jun-cc-pVDZ-JKFIT")
    ...
    basis_ccpwcvtz.add_jkfit("cc-pVTZ-JKFIT")
    basis_ccpwcv_tpd_z.add_jkfit("cc-pVTZ-JKFIT")
    basis_augccpwcvtz.add_jkfit("aug-cc-pVTZ-JKFIT")
    basis_augccpwcv_tpd_z.add_jkfit("aug-cc-pVTZ-JKFIT")
    basis_heavyaugccpwcvtz.add_jkfit("heavy-aug-cc-pVTZ-JKFIT")
    basis_heavyaugccpwcv_tpd_z.add_jkfit("heavy-aug-cc-pVTZ-JKFIT")
    basis_junccpwcvtz.add_jkfit("jun-cc-pVTZ-JKFIT")
    basis_junccpwcv_tpd_z.add_jkfit("jun-cc-pVTZ-JKFIT")
    basis_mayccpwcvtz.add_jkfit("may-cc-pVTZ-JKFIT")
    basis_mayccpwcv_tpd_z.add_jkfit("may-cc-pVTZ-JKFIT")
    ...
    basis_ccpwcvqz.add_jkfit("cc-pVQZ-JKFIT")
    basis_ccpwcv_qpd_z.add_jkfit("cc-pVQZ-JKFIT")
    basis_augccpwcvqz.add_jkfit("aug-cc-pVQZ-JKFIT")
    basis_augccpwcv_qpd_z.add_jkfit("aug-cc-pVQZ-JKFIT")
    basis_heavyaugccpwcvqz.add_jkfit("heavy-aug-cc-pVQZ-JKFIT")
    basis_heavyaugccpwcv_qpd_z.add_jkfit("heavy-aug-cc-pVQZ-JKFIT")
    basis_junccpwcvqz.add_jkfit("jun-cc-pVQZ-JKFIT")
    basis_junccpwcv_qpd_z.add_jkfit("jun-cc-pVQZ-JKFIT")
    basis_mayccpwcvqz.add_jkfit("may-cc-pVQZ-JKFIT")
    basis_mayccpwcv_qpd_z.add_jkfit("may-cc-pVQZ-JKFIT")
    basis_aprccpwcvqz.add_jkfit("apr-cc-pVQZ-JKFIT")
    basis_aprccpwcv_qpd_z.add_jkfit("apr-cc-pVQZ-JKFIT")
    ...
    basis_ccpwcv5z.add_jkfit("cc-pV5Z-JKFIT")
    basis_ccpwcv_5pd_z.add_jkfit("cc-pV5Z-JKFIT")
    basis_augccpwcv5z.add_jkfit("aug-cc-pV5Z-JKFIT")
    basis_augccpwcv_5pd_z.add_jkfit("aug-cc-pV5Z-JKFIT")
    basis_heavyaugccpwcv5z.add_jkfit("heavy-aug-cc-pV5Z-JKFIT")
    basis_heavyaugccpwcv_5pd_z.add_jkfit("heavy-aug-cc-pV5Z-JKFIT")
    basis_junccpwcv5z.add_jkfit("jun-cc-pV5Z-JKFIT")
    basis_junccpwcv_5pd_z.add_jkfit("jun-cc-pV5Z-JKFIT")
    basis_mayccpwcv5z.add_jkfit("may-cc-pV5Z-JKFIT")
    basis_mayccpwcv_5pd_z.add_jkfit("may-cc-pV5Z-JKFIT")
    basis_aprccpwcv5z.add_jkfit("apr-cc-pV5Z-JKFIT")
    basis_aprccpwcv_5pd_z.add_jkfit("apr-cc-pV5Z-JKFIT")
    basis_marccpwcv5z.add_jkfit("mar-cc-pV5Z-JKFIT")
    basis_marccpwcv_5pd_z.add_jkfit("mar-cc-pV5Z-JKFIT")
    ...
    basis_ccpvdz.add_guess("pcseg-0")
    basis_ccpv_dpd_z.add_guess("pcseg-0")
    basis_ccpwcvdz.add_guess("pcseg-0")
    basis_ccpwcv_dpd_z.add_guess("pcseg-0")
    basis_augccpvdz.add_guess("pcseg-0")
    basis_augccpv_dpd_z.add_guess("pcseg-0")
    basis_augccpwcvdz.add_guess("pcseg-0")
    basis_augccpwcv_dpd_z.add_guess("pcseg-0")
    basis_heavyaugccpvdz.add_guess("pcseg-0")
    basis_heavyaugccpv_dpd_z.add_guess("pcseg-0")
    basis_heavyaugccpwcvdz.add_guess("pcseg-0")
    basis_heavyaugccpwcv_dpd_z.add_guess("pcseg-0")
    basis_junccpvdz.add_guess("pcseg-0")
    basis_junccpv_dpd_z.add_guess("pcseg-0")
    basis_junccpwcvdz.add_guess("pcseg-0")
    basis_junccpwcv_dpd_z.add_guess("pcseg-0")
    basis_ccpvtz.add_guess("pcseg-0")
    basis_ccpv_tpd_z.add_guess("pcseg-0")
    basis_ccpwcvtz.add_guess("pcseg-0")
    basis_ccpwcv_tpd_z.add_guess("pcseg-0")
    basis_augccpvtz.add_guess("pcseg-0")
    basis_augccpv_tpd_z.add_guess("pcseg-0")
    basis_augccpwcvtz.add_guess("pcseg-0")
    basis_augccpwcv_tpd_z.add_guess("pcseg-0")
    basis_heavyaugccpvtz.add_guess("pcseg-0")
    basis_heavyaugccpv_tpd_z.add_guess("pcseg-0")
    basis_heavyaugccpwcvtz.add_guess("pcseg-0")
    basis_heavyaugccpwcv_tpd_z.add_guess("pcseg-0")
    basis_junccpvtz.add_guess("pcseg-0")
    basis_junccpv_tpd_z.add_guess("pcseg-0")
    basis_junccpwcvtz.add_guess("pcseg-0")
    basis_junccpwcv_tpd_z.add_guess("pcseg-0")
    basis_mayccpvtz.add_guess("pcseg-0")
    basis_mayccpv_tpd_z.add_guess("pcseg-0")
    basis_mayccpwcvtz.add_guess("pcseg-0")
    basis_mayccpwcv_tpd_z.add_guess("pcseg-0")
    basis_ccpvqz.add_guess("pcseg-0")
    basis_ccpv_qpd_z.add_guess("pcseg-0")
    basis_ccpwcvqz.add_guess("pcseg-0")
    basis_ccpwcv_qpd_z.add_guess("pcseg-0")
    basis_augccpvqz.add_guess("pcseg-0")
    basis_augccpv_qpd_z.add_guess("pcseg-0")
    basis_augccpwcvqz.add_guess("pcseg-0")
    basis_augccpwcv_qpd_z.add_guess("pcseg-0")
    basis_heavyaugccpvqz.add_guess("pcseg-0")
    basis_heavyaugccpv_qpd_z.add_guess("pcseg-0")
    basis_heavyaugccpwcvqz.add_guess("pcseg-0")
    basis_heavyaugccpwcv_qpd_z.add_guess("pcseg-0")
    basis_junccpvqz.add_guess("pcseg-0")
    basis_junccpv_qpd_z.add_guess("pcseg-0")
    basis_junccpwcvqz.add_guess("pcseg-0")
    basis_junccpwcv_qpd_z.add_guess("pcseg-0")
    basis_mayccpvqz.add_guess("pcseg-0")
    basis_mayccpv_qpd_z.add_guess("pcseg-0")
    basis_mayccpwcvqz.add_guess("pcseg-0")
    basis_mayccpwcv_qpd_z.add_guess("pcseg-0")
    basis_aprccpvqz.add_guess("pcseg-0")
    basis_aprccpv_qpd_z.add_guess("pcseg-0")
    basis_aprccpwcvqz.add_guess("pcseg-0")
    basis_aprccpwcv_qpd_z.add_guess("pcseg-0")
    basis_ccpv5z.add_guess("pcseg-0")
    basis_ccpv_5pd_z.add_guess("pcseg-0")
    basis_ccpwcv5z.add_guess("pcseg-0")
    basis_ccpwcv_5pd_z.add_guess("pcseg-0")
    basis_augccpv5z.add_guess("pcseg-0")
    basis_augccpv_5pd_z.add_guess("pcseg-0")
    basis_augccpwcv5z.add_guess("pcseg-0")
    basis_augccpwcv_5pd_z.add_guess("pcseg-0")
    basis_heavyaugccpv5z.add_guess("pcseg-0")
    basis_heavyaugccpv_5pd_z.add_guess("pcseg-0")
    basis_heavyaugccpwcv5z.add_guess("pcseg-0")
    basis_heavyaugccpwcv_5pd_z.add_guess("pcseg-0")
    basis_junccpv5z.add_guess("pcseg-0")
    basis_junccpv_5pd_z.add_guess("pcseg-0")
    basis_junccpwcv5z.add_guess("pcseg-0")
    basis_junccpwcv_5pd_z.add_guess("pcseg-0")
    basis_mayccpv5z.add_guess("pcseg-0")
    basis_mayccpv_5pd_z.add_guess("pcseg-0")
    basis_mayccpwcv5z.add_guess("pcseg-0")
    basis_mayccpwcv_5pd_z.add_guess("pcseg-0")
    basis_aprccpv5z.add_guess("pcseg-0")
    basis_aprccpv_5pd_z.add_guess("pcseg-0")
    basis_aprccpwcv5z.add_guess("pcseg-0")
    basis_aprccpwcv_5pd_z.add_guess("pcseg-0")
    basis_marccpv5z.add_guess("pcseg-0")
    basis_marccpv_5pd_z.add_guess("pcseg-0")
    basis_marccpwcv5z.add_guess("pcseg-0")
    basis_marccpwcv_5pd_z.add_guess("pcseg-0")
    basis_ccpv6z.add_guess("pcseg-0")
    basis_ccpv_6pd_z.add_guess("pcseg-0")
    basis_augccpv6z.add_guess("pcseg-0")
    basis_augccpv_6pd_z.add_guess("pcseg-0")
    basis_heavyaugccpv6z.add_guess("pcseg-0")
    basis_heavyaugccpv_6pd_z.add_guess("pcseg-0")
    basis_junccpv6z.add_guess("pcseg-0")
    basis_junccpv_6pd_z.add_guess("pcseg-0")
    basis_mayccpv6z.add_guess("pcseg-0")
    basis_mayccpv_6pd_z.add_guess("pcseg-0")
    basis_aprccpv6z.add_guess("pcseg-0")
    basis_aprccpv_6pd_z.add_guess("pcseg-0")
    basis_marccpv6z.add_guess("pcseg-0")
    basis_marccpv_6pd_z.add_guess("pcseg-0")
    basis_febccpv6z.add_guess("pcseg-0")
    basis_febccpv_6pd_z.add_guess("pcseg-0")
