...
using_psi4 = pytest.mark.skipif(
    _plugin_import("psi4") is False, reason="Not detecting module psi4. Install package and add to envvar PYTHONPATH"
)
...
using_psi4_molrec = pytest.mark.skipif(
    is_psi4_new_enough("1.2a1.dev999") is False,
