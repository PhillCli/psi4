...
def bars(data, title="", saveas=None, relpath=False, graphicsformat=["pdf"], view=True):
    ...
    *data*. The plot is labeled with *title* and each bar with *mc* key and
    ...
    # save and show
    pltuid = (
        title + "_" + hashlib.sha1((title + repr([bar["mc"] for bar in data if bar is not None])).encode()).hexdigest()
    )
        ...
        for dbse, rxn, val, show, x, y in posnM:
            ...
            if now == last:
                ...
                htmlcode += (
                    ...
                    % (x - 2, img_height - y - 20, x + 2, img_height - y + 20, dbse, rxn, val, show)
                )
                last = now
...
def ternary(sapt, title="", labeled=True, view=True, saveas=None, relpath=False, graphicsformat=["pdf"]):
    ...
    sc = ax.scatter(
        xvals, yvals, c=cvals, s=15, marker="o", cmap=mpl.cm.jet, edgecolor="none", vmin=0, vmax=1, zorder=10
    )
    ...
    # save and show
    pltuid = (
        title + "_" + ("lbld" if labeled else "bare") + "_" + hashlib.sha1((title + repr(sapt)).encode()).hexdigest()
    )
...
if __name__ == "__main__":
    ...
    flat(
        [
            ...
            {"sys": "10", "color": 0.25493207637105103, "data": [-0.020199999999999996]},
            ...
            {"sys": "BzBz_T-5.2", "color": 0.254318060864096, "data": [-0.32230000000000025]},
            {"sys": "BzBz_T-5.1", "color": 0.26598486566733337, "data": [-0.3428]},
            {"sys": "BzBz_T-5.0", "color": 0.28011258347610224, "data": [-0.36060000000000025]},
            {"sys": "PyPy_S2-3.9", "color": 0.14520332101084785, "data": [-0.9853000000000001]},
            {"sys": "PyPy_S2-3.8", "color": 0.1690757103699542, "data": [-1.0932]},
            {"sys": "PyPy_S2-3.5", "color": 0.25615734567417053, "data": [-1.4617]},
            {"sys": "PyPy_S2-3.7", "color": 0.19566550224566906, "data": [-1.2103999999999995]},
            {"sys": "PyPy_S2-3.6", "color": 0.22476748600170826, "data": [-1.3333]},
            {"sys": "BzBz_PD32-2.0", "color": 0.31605681987208084, "data": [-1.6637]},
            {"sys": "BzBz_T-4.8", "color": 0.31533827331543723, "data": [-0.38759999999999994]},
            {"sys": "BzBz_T-4.9", "color": 0.2966146678069063, "data": [-0.3759999999999999]},
            {"sys": "BzH2S-3.6", "color": 0.38284814928043304, "data": [-0.1886000000000001]},
            {"sys": "BzBz_PD32-1.7", "color": 0.3128835191478639, "data": [-1.8703999999999998]},
            {"sys": "BzMe-3.8", "color": 0.24117892478245323, "data": [-0.034399999999999986]},
            {"sys": "BzMe-3.9", "color": 0.22230903086047088, "data": [-0.046499999999999986]},
            {"sys": "BzH2S-3.7", "color": 0.36724255203373696, "data": [-0.21039999999999992]},
            {"sys": "BzMe-3.6", "color": 0.284901522674611, "data": [0.007099999999999884]},
            {"sys": "BzMe-3.7", "color": 0.2621086166558813, "data": [-0.01770000000000005]},
            {"sys": "BzBz_PD32-1.9", "color": 0.314711251903219, "data": [-1.7353999999999998]},
            {"sys": "BzBz_PD32-1.8", "color": 0.3136181753200793, "data": [-1.8039999999999998]},
            {"sys": "BzH2S-3.8", "color": 0.3542001591399945, "data": [-0.22230000000000016]},
            {"sys": "BzBz_PD36-1.9", "color": 0.14128552184232473, "data": [-1.1517]},
            {"sys": "BzBz_S-3.7", "color": 0.08862098445220466, "data": [-1.3414]},
            {"sys": "BzH2S-4.0", "color": 0.33637540012259076, "data": [-0.2265999999999999]},
            ...
            {"sys": "PyPy_T3-5.1", "color": 0.3207725129126432, "data": [-0.2958000000000003]},
            {"sys": "PyPy_T3-5.0", "color": 0.3254925304351165, "data": [-0.30710000000000015]},
            {"sys": "BzBz_PD36-1.7", "color": 0.13577087141986593, "data": [-1.2333000000000003]},
            {"sys": "PyPy_T3-4.8", "color": 0.3443704059902452, "data": [-0.32010000000000005]},
            {"sys": "PyPy_T3-4.9", "color": 0.3333442013628509, "data": [-0.3158999999999996]},
            {"sys": "PyPy_T3-4.7", "color": 0.35854000505665756, "data": [-0.31530000000000014]},
            {"sys": "BzBz_PD36-1.6", "color": 0.13364651314909243, "data": [-1.2705000000000002]},
            {"sys": "BzMe-4.0", "color": 0.20560117919562013, "data": [-0.05389999999999984]},
            {"sys": "MeMe-3.6", "color": 0.16934865900383142, "data": [0.18420000000000003]},
            {"sys": "MeMe-3.7", "color": 0.1422332591197123, "data": [0.14680000000000004]},
            {"sys": "MeMe-3.4", "color": 0.23032794290360467, "data": [0.29279999999999995]},
            {"sys": "MeMe-3.5", "color": 0.19879551978386897, "data": [0.23260000000000003]},
            {"sys": "MeMe-3.8", "color": 0.11744404936205816, "data": [0.11680000000000001]},
            {"sys": "BzBz_PD34-1.7", "color": 0.22537382457222138, "data": [-1.5286999999999997]},
            {"sys": "BzBz_PD34-1.6", "color": 0.22434088042760192, "data": [-1.5754000000000001]},
            {"sys": "BzBz_PD32-2.2", "color": 0.3189891685300601, "data": [-1.5093999999999999]},
            {"sys": "BzBz_S-4.1", "color": 0.10884135031532088, "data": [-0.8547000000000002]},
            {"sys": "BzBz_S-4.0", "color": 0.06911476296747143, "data": [-0.9590000000000001]},
            {"sys": "BzBz_PD34-1.8", "color": 0.22685419834431494, "data": [-1.476]},
            {"sys": "BzBz_PD34-1.9", "color": 0.2287079261672095, "data": [-1.4223999999999997]},
            {"sys": "BzH2S-3.9", "color": 0.3439077006047999, "data": [-0.22739999999999982]},
            {"sys": "FaNNFaNN-4.1", "color": 0.7512716174974567, "data": [1.7188999999999997]},
            {"sys": "FaNNFaNN-4.0", "color": 0.7531388297328865, "data": [1.9555000000000007]},
            {"sys": "FaNNFaNN-4.3", "color": 0.7478064149182957, "data": [1.2514000000000003]},
            {"sys": "FaNNFaNN-4.2", "color": 0.7493794908838113, "data": [1.4758000000000013]},
            {"sys": "FaOOFaON-4.0", "color": 0.7589275618320565, "data": [2.0586]},
            {"sys": "FaOOFaON-3.7", "color": 0.7619465815742713, "data": [3.3492999999999995]},
            {"sys": "FaOOFaON-3.9", "color": 0.7593958895631474, "data": [2.4471000000000007]},
            {"sys": "FaOOFaON-3.8", "color": 0.7605108059280967, "data": [2.8793999999999986]},
            {"sys": "FaONFaON-4.1", "color": 0.7577459277014137, "data": [1.8697999999999997]},
            {"sys": "FaOOFaON-3.6", "color": 0.7633298028299997, "data": [3.847599999999998]},
            {"sys": "FaNNFaNN-3.9", "color": 0.7548200901251662, "data": [2.2089]},
            {"sys": "FaONFaON-3.8", "color": 0.7582294603551467, "data": [2.967699999999999]},
            {"sys": "FaONFaON-3.9", "color": 0.7575285282217349, "data": [2.578900000000001]},
            {"sys": "FaONFaON-4.2", "color": 0.7594549221042256, "data": [1.5579999999999998]},
            {"sys": "FaOOFaNN-3.6", "color": 0.7661655616885379, "data": [3.701599999999999]},
            {"sys": "FaOOFaNN-3.7", "color": 0.7671068376007428, "data": [3.156500000000001]},
            {"sys": "FaOOFaNN-3.8", "color": 0.766947626251711, "data": [2.720700000000001]},
            {"sys": "FaONFaNN-3.9", "color": 0.7569836601896789, "data": [2.4281000000000006]},
            {"sys": "FaONFaNN-3.8", "color": 0.758024548462959, "data": [2.7561999999999998]},
            {"sys": "FaOOFaOO-3.6", "color": 0.7623422640217077, "data": [3.851800000000001]},
            {"sys": "FaOOFaOO-3.7", "color": 0.7597430792159379, "data": [3.2754999999999974]},
            {"sys": "FaOOFaOO-3.4", "color": 0.7672554950739594, "data": [5.193299999999999]},
            {"sys": "FaOOFaOO-3.5", "color": 0.764908813123865, "data": [4.491900000000001]},
            {"sys": "FaONFaNN-4.2", "color": 0.7549212942233738, "data": [1.534699999999999]},
            {"sys": "FaONFaNN-4.0", "color": 0.7559404310956357, "data": [2.1133000000000024]},
            {"sys": "FaONFaNN-4.1", "color": 0.7551574698775625, "data": [1.813900000000002]},
            {"sys": "FaONFaON-4.0", "color": 0.7572064604483282, "data": [2.2113999999999994]},
            {"sys": "FaOOFaOO-3.8", "color": 0.7573810956831686, "data": [2.7634000000000007]},
