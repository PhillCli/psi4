...
class Publication(QCEssential):
    ...
    def __init__(self, name, fullname=None, latex=None, dsdbid=None, doi=None, comment=None, owner=None):
        ...
        QCEssential.__init__(
            self, name=name, fullname=primary.fullname, latex=latex, citations=cits, doi=primary.doi, comment=comment
        )
        self.name = name.lower()
...
_tlist = [
    ...
    BasisSet(
        "atzdz", fullname="[aTZ; D:DZ]", latex=r"""[aTZ; $\delta$:DZ]""", build=[None, None, ["atz", "atz", "dz"]]
    ),
    BasisSet(
        "adtzdz", fullname="[aDTZ; D:DZ]", latex=r"""[aDTZ; $\delta$:DZ]""", build=[None, None, ["atz", "adtz", "dz"]]
    ),
    BasisSet(
        "atqzdz", fullname="[aTQZ; D:DZ]", latex=r"""[aTQZ; $\delta$:DZ]""", build=[None, None, ["aqz", "atqz", "dz"]]
    ),
    BasisSet(
        "atzjadz",
        fullname="[aTZ; D:jaDZ]",
    ...
    BasisSet(
        "atzadz", fullname="[aTZ; D:aDZ]", latex=r"""[aTZ; $\delta$:aDZ]""", build=[None, None, ["atz", "atz", "adz"]]
    ),
    BasisSet(
        "adtzadz",
        fullname="[aDTZ; D:aDZ]",
    ...
    BasisSet(
        "atzdtz", fullname="[aTZ; D:DTZ]", latex=r"""[aTZ; $\delta$:DTZ]""", build=[None, None, ["atz", "atz", "dtz"]]
    ),
    BasisSet(
        "atqzdtz",
        fullname="[aTQZ; D:DTZ]",
    ...
    BasisSet(
        "atqztz", fullname="[aTQZ; D:TZ]", latex=r"""[aTQZ; $\delta$:TZ]""", build=[None, None, ["aqz", "atqz", "tz"]]
    ),
    BasisSet(
        "atqzjatz",
    ...
    BasisSet(
        "hill1_adtz", build=[["hillcc_adtz"], ["atz", "hillcc_adtz"]]
    ),  # TODO should have None or non-xtpl first element?
