...
funcs.append(
    {
        ...
        "x_hf": {"alpha": 0.25, "beta": 0.75, "omega": 0.3},
...
funcs.append(
    {
        ...
        "x_hf": {"alpha": 1.0},
        "c_functionals": {},
        "dispersion": {"type": "d3bj2b", "params": {"s6": 1.000, "s8": 0.8777, "a1": 0.4171, "a2": 2.9149}},
...
funcs.append(
    {
        ...
        "dispersion": {"type": "d3bj2b", "params": {"s6": 1.000, "s8": 0.0000, "a1": 0.4860, "a2": 4.5000}},
...
funcs.append(
    {
        "name": "wB97X3c",
        "alias": ["wB97X-3C"],
        "xc_functionals": {"HYB_GGA_XC_WB97X_V": {}},
        "dispersion": {
            "type": "d4bjeeqatm",
            "nlc": False,
            "params": {
...
funcs.append(
    {
        "name": "N12-SX",
        "alias": ["N12SX"],
        "x_functionals": {"HYB_GGA_X_N12_SX": {"use_libxc": True}},
        "c_functionals": {"GGA_C_N12_SX": {}},
...
funcs.append(
    {
        "name": "revPBE0",
        "x_functionals": {"GGA_X_PBE_R": {"alpha": 0.75}},
        "x_hf": {"alpha": 0.25},
        "c_functionals": {"GGA_C_PBE": {}},
...
funcs.append(
    {
        "name": "mPW1LYP",
        "x_functionals": {"GGA_X_MPW91": {"alpha": 0.75}},
        "x_hf": {"alpha": 0.25},
...
funcs.append(
    {
        ...
        "x_functionals": {"HYB_MGGA_X_MS2H": {"use_libxc": True}},
...
funcs.append(
    {
        ...
        "x_functionals": {"HYB_MGGA_X_MVSH": {"use_libxc": True}},
        "c_functionals": {"GGA_C_REGTPSS": {}},
...
funcs.append(
    {
        "name": "PW6B95",
        "x_functionals": {"GGA_X_MPW91": {"tweak": get_pw6b95_tweaks(), "alpha": 0.72}},
        "x_hf": {"alpha": 0.28},
        "c_functionals": {
            "MGGA_C_BC95": {
                "tweak": {
...
funcs.append(
    {
        "name": "M05",
        "x_functionals": {"HYB_MGGA_X_M05": {"use_libxc": True}},
        "c_functionals": {"MGGA_C_M05": {}},
...
funcs.append(
    {
        "name": "M05-2X",
        "alias": ["M052X"],
        "x_functionals": {"HYB_MGGA_X_M05_2X": {"use_libxc": True}},
        "c_functionals": {"MGGA_C_M05_2X": {}},
...
funcs.append(
    {
        "name": "M06",
        "x_functionals": {"HYB_MGGA_X_M06": {"use_libxc": True}},
        "c_functionals": {"MGGA_C_M06": {}},
...
funcs.append(
    {
        "name": "M06-2X",
        "alias": ["M062X"],
        "x_functionals": {"HYB_MGGA_X_M06_2X": {"use_libxc": True}},
        "c_functionals": {"MGGA_C_M06_2X": {}},
...
funcs.append(
    {
        "name": "M06-HF",
        "alias": ["M06HF"],
        "x_functionals": {"HYB_MGGA_X_M06_HF": {"use_libxc": True}},
        "c_functionals": {"MGGA_C_M06_HF": {}},
...
funcs.append(
    {
        "name": "M08-HX",
        "alias": ["M08HX"],
        "x_functionals": {"HYB_MGGA_X_M08_HX": {"use_libxc": True}},
        "c_functionals": {"MGGA_C_M08_HX": {}},
...
funcs.append(
    {
        "name": "M08-SO",
        "alias": ["M08SO"],
        "x_functionals": {"HYB_MGGA_X_M08_SO": {"use_libxc": True}},
        "c_functionals": {"MGGA_C_M08_SO": {}},
...
funcs.append(
    {
        "name": "M11",
        "x_functionals": {"HYB_MGGA_X_M11": {"use_libxc": True}},
        "c_functionals": {"MGGA_C_M11": {}},
...
funcs.append(
    {
        "name": "wB97M-D3BJ",
        "xc_functionals": {"HYB_MGGA_XC_WB97M_V": {}},
        "dispersion": {
            "nlc": False,
            "type": "d3bj2b",
            "citation": "    A. Najib, L. Goerigk, J. Comput. Theory Chem.,14, 5725, 2018\n",
            "params": {"s6": 1.000, "s8": 0.3908, "a1": 0.5660, "a2": 3.1280},
        },
...
funcs.append(
    {
        ...
        "dispersion": {
            ...
            "type": "d3bj2b",
            "citation": "    A. Najib, L. Goerigk, J. Comput. Theory Chem.,14 5725, 2018\n",
            "params": {"s6": 1.000, "s8": 0.2641, "a1": 0.0000, "a2": 5.4959},
        },
...
funcs.append(
    {
        "name": "SCAN0",
        "x_functionals": {"HYB_MGGA_X_SCAN0": {"use_libxc": True}},
...
funcs.append(
    {
        "name": "revSCAN0",
        "x_functionals": {"HYB_MGGA_X_REVSCAN0": {"use_libxc": True}},
        "c_functionals": {"MGGA_C_REVSCAN": {}},
...
funcs.append(
    {
        "name": "BMK",
        "x_functionals": {"HYB_MGGA_X_BMK": {"use_libxc": True}},
        "c_functionals": {"GGA_C_BMK": {}},
...
funcs.append(
    {
        ...
        "c_functionals": {"GGA_C_HYB_TAU_HCTH": {}},
