...
funcs.append(
    {
        ...
        "x_functionals": {"GGA_X_B88": {"alpha": 0.29}},
        "x_hf": {"alpha": 0.71},
        "c_functionals": {"GGA_C_LYP": {"alpha": 0.54}},
        "c_mp2": {
            "os": 0.47,
            "ss": 0.40,
        },
        "dispersion": {
            "type": "d3bj2b",
            "params": {"s6": 0.57, "a2": 5.4, "a1": 0.0, "s8": 0.0},
            "citation": "    S. Kozuch, J.M.L. Martin, J. Comp. Chem., 34, 2327-2344, 2013\n",
        },
        "citation": "    S. Kozuch, J.M.L. Martin, J. Comp. Chem., 34, 2327-2344, 2013\n",
...
funcs.append(
    {
        "name": "CORE-DSD-BLYP",
        "x_functionals": {"GGA_X_B88": {"alpha": 0.31}},
        "x_hf": {"alpha": 0.69},
        "c_functionals": {"GGA_C_LYP": {"alpha": 0.54}},
        "c_mp2": {"os": 0.46, "ss": 0.37},
...
funcs.append(
    {
        ...
        "x_functionals": {"GGA_X_PBE": {"alpha": 0.31}},
        "x_hf": {"alpha": 0.69},
        "c_functionals": {"GGA_C_P86": {"alpha": 0.44}},
        "c_mp2": {"os": 0.52, "ss": 0.22},
        "dispersion": {
            "type": "d3bj2b",
            "params": {"s6": 0.48, "a2": 5.6, "a1": 0.0, "s8": 0.0},
            "citation": "    S. Kozuch, J.M.L. Martin, J. Comp. Chem., 34, 2327-2344, 2013\n",
        },
        "citation": "    S. Kozuch, J.M.L. Martin, J. Comp. Chem., 34, 2327-2344, 2013\n",
...
funcs.append(
    {
        ...
        "x_functionals": {"GGA_X_PBE": {"alpha": 0.32}},
        "x_hf": {"alpha": 0.68},
        "c_functionals": {"GGA_C_PBE": {"alpha": 0.49}},
        "c_mp2": {"os": 0.55, "ss": 0.13},
        "citation": "    S. Kozuch, J.M.L. Martin, J. Comp. Chem., 34, 2327-2344, 2013\n",
        "description": "    DSD-PBEPBE-D3BJ Dispersion-corrected SCS Double Hybrid XC Functional\n",
        "dispersion": {
            "type": "d3bj2b",
            "params": {"s6": 0.78, "a2": 6.1, "a1": 0.0, "s8": 0.0},
            "citation": "    S. Kozuch, J.M.L. Martin, J. Comp. Chem., 34, 2327-2344, 2013\n",
        },
    }
)
...
funcs.append(
    {
        ...
        "x_hf": {"alpha": 0.68},
        "c_functionals": {"GGA_C_PBE": {"alpha": 0.49}},
        "c_mp2": {"alpha": 1.0, "os": 0.55, "ss": 0.13},
        "citation": "    S. Kozuch, J.M.L. Martin, J. Comp. Chem., 34, 2327-2344, 2013\n",
...
funcs.append(
    {
        ...
        "x_functionals": {"GGA_X_PBE": {"alpha": 0.31}},
        "x_hf": {"alpha": 0.69},
        "c_functionals": {"MGGA_C_BC95": {"alpha": 0.54}},
        "c_mp2": {"os": 0.48, "ss": 0.22},
        "citation": "    S. Kozuch, J.M.L. Martin, J. Comp. Chem., 34, 2327-2344, 2013\n",
...
funcs.append(
    {
        "name": "DSD-PBEB95-D2",
        "x_functionals": {"GGA_X_PBE": {"alpha": 0.35}},
        "x_hf": {"alpha": 0.65},
        "c_functionals": {"MGGA_C_BC95": {"alpha": 0.55}},
        "c_mp2": {"os": 0.46, "ss": 0.08},
        "citation": "    S. Kozuch, J.M.L. Martin, J. Comp. Chem., 34, 2327-2344, 2013\n",
        "description": "    DSD-PBEB95-D2 Dispersion-corrected SCS Double Hybrid Meta-GGA XC Functional\n",
        "dispersion": {
            "type": "d2",
            "params": {"s6": 0.32, "alpha6": 20.0, "sr6": 1.1},
            "citation": "    S. Kozuch, J.M.L. Martin, J. Comp. Chem., 34, 2327-2344, 2013\n",
        },
    }
)
