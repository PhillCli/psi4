...
funcs.append(
    {
        "name": "N12",
        "x_functionals": {"GGA_X_N12": {}},
        "c_functionals": {"GGA_C_N12": {}},
...
funcs.append(
    {
        "name": "B97-D2",
        "xc_functionals": {"GGA_XC_B97_D": {}},
        "dispersion": {"type": "d2", "params": {"s6": 1.25, "alpha6": 20.0, "sr6": 1.1}},
    }
)
...
funcs.append(
    {
        ...
        "dispersion": {
            "type": "d3zero2b",
            "params": {"s6": 1.0, "s8": 0.909, "sr6": 0.892, "sr8": 1.0, "alpha6": 14.0},
        },
    }
)
...
funcs.append(
    {
        "name": "B97-D3BJ",
        "xc_functionals": {"GGA_XC_B97_D": {}},
        "dispersion": {"type": "d3bj2b", "params": {"s6": 1.000, "s8": 2.2609, "a1": 0.5545, "a2": 3.2297}},
    }
)
...
funcs.append(
    {
        ...
        "dispersion": {
            "type": "d3mzero2b",
            "params": {"s6": 1.000, "s8": 1.020078, "sr6": 1.151808, "beta": 0.035964},
        },
    }
)
...
funcs.append(
    {
        "name": "B97-D3MBJ",
        "xc_functionals": {"GGA_XC_B97_D": {}},
        "dispersion": {"type": "d3mbj2b", "params": {"s6": 1.000, "s8": 1.206988, "a1": 0.240184, "a2": 3.864426}},
    }
)
...
funcs.append(
    {
        "name": "GAM",
        "x_functionals": {"GGA_X_GAM": {}},
        "c_functionals": {"GGA_C_GAM": {}},
...
funcs.append(
    {
        "name": "PBE-SOL",
        "alias": ["PBESOL"],
        "x_functionals": {"GGA_X_PBE_SOL": {}},
        "c_functionals": {"GGA_C_PBE_SOL": {}},
