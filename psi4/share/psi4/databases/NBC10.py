...
for item in BzBz_PD34:
    ...
    TAGL["%s-%s-dimer" % (dbse, item)] = "Parallel Displaced Benzene Dimer Interplane 3.4 at %s A" % (
        distance.group(2)
    )
    TAGL["%s-%s-monoA-CP" % (dbse, item)] = "Benzene from Parallel Displaced Benzene Dimer Interplane 3.4 at %s A" % (
        distance.group(2)
    )
...
for item in PyPy_S2:
    ...
    TAGL["%s-%s-monoA-CP" % (dbse, item)] = "Pyridine from Pyridine Dimer S2 Configuration at %s A" % (
        distance.group(2)
    )
...
for item in PyPy_T3:
    ...
    TAGL["%s-%s-monoA-CP" % (dbse, item)] = "Pyridine from Pyridine Dimer T3 Configuration at %s A" % (
        distance.group(2)
    )
    TAGL["%s-%s-monoB-CP" % (dbse, item)] = "Pyridine from Pyridine Dimer T3 Configuration at %s A" % (
        distance.group(2)
    )
...
for item in BzBz_PD32:
    ...
    TAGL["%s-%s-dimer" % (dbse, item)] = "Parallel Displaced Benzene Dimer Interplane 3.2 at %s A" % (
        distance.group(2)
    )
    TAGL["%s-%s-monoA-CP" % (dbse, item)] = "Benzene from Parallel Displaced Benzene Dimer Interplane 3.2 at %s A" % (
        distance.group(2)
    )
...
for item in BzBz_PD36:
    ...
    TAGL["%s-%s-dimer" % (dbse, item)] = "Parallel Displaced Benzene Dimer Interplane 3.6 at %s A" % (
        distance.group(2)
    )
    TAGL["%s-%s-monoA-CP" % (dbse, item)] = "Benzene from Parallel Displaced Benzene Dimer Interplane 3.6 at %s A" % (
        distance.group(2)
    )
