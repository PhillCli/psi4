...
std::vector<std::vector<int>> chain_maps(const std::vector<std::vector<int>> &x_to_y,
                                         const std::vector<std::vector<int>> &y_to_z) {
    int nx = x_to_y.size();
...
std::vector<std::vector<int>> extend_maps(const std::vector<std::vector<int>> &x_to_y,
