                ...
                for (i = 0; i < occpi[Gi]; i++) {
                    ...
                    for (j = 0; j < occpi[Gj]; j++) {
                        ...
                        for (k = 0; k < occpi[Gk]; k++) {
                            ...
                            L3_AAA(W1, nirreps, I, Gi, J, Gj, K, Gk, &L, &F, &E, &fIJ, &fAB, &Dints, &LIJAB, &LIA, &FME,
                            ...
                            for (Gd = 0; Gd < nirreps; Gd++) {
                                ...
                                WMAFE.matrix[Gid] =
                                    global_dpd_->dpd_block_matrix(virtpi[Gd], WMAFE.params->coltot[Gid]);
                            ...
                            for (Gm = 0; Gm < nirreps; Gm++) {
                                ...
                                for (m = 0; m < occpi[Gm]; m++) {
                                    ...
                                    if (nrows && ncols)
                                        C_DGEMV('n', nrows, ncols, -0.5, W2[Ga][0], ncols, T2.matrix[Gmk][mk], 1, 1.0,
                                                &(ZLMAO.matrix[Gij][ij][am]), occpi[Gm]);
                                }
                            }
                            ...
                            for (Gm = 0; Gm < nirreps; Gm++) {
                                ...
                                for (m = 0; m < occpi[Gm]; m++) {
                                    ...
                                    if (nrows && ncols)
                                        C_DGEMV('n', nrows, ncols, -0.5, W2[Gb][0], ncols, T2.matrix[Gmk][mk], 1, 1.0,
                                                &(ZIMLE.matrix[Gij][ij][mb]), 1);
                                }
                            }
        ...
        for (Gj = 0; Gj < nirreps; Gj++) {
            ...
            for (Gk = 0; Gk < nirreps; Gk++) {
                ...
                for (Ga = 0; Ga < nirreps; Ga++) {
                    ...
                    W2[Ga] =
                        global_dpd_->dpd_block_matrix(virtpi[Ga], WmAfE.params->coltot[Gcb]); /* alpha-beta-alpha */
                }
                ...
                for (i = 0; i < occpi[Gi]; i++) {
                    ...
                    for (j = 0; j < occpi[Gj]; j++) {
                        ...
                        for (k = 0; k < occpi[Gk]; k++) {
                            ...
                            L3_AAB(W1, nirreps, I, Gi, J, Gj, K, Gk, &L2AA, &L2AB, &L2BA, &FAA, &FAB, &FBA, &EAA, &EAB,
                                   &EBA, &fIJ, &fij, &fAB, &fab, &DAAints, &DABints, &LIJAB, &LIjAb, &LIA, &Lia, &FME,
                                   &Fme, occpi, occ_off, occpi, occ_off, virtpi, vir_off, virtpi, vir_off);
                            ...
                            for (Gd = 0; Gd < nirreps; Gd++) {
                                ...
                                WmAfE.matrix[Gkd] =
                                    global_dpd_->dpd_block_matrix(virtpi[Gd], WmAfE.params->coltot[Gkd]);
                            ...
                            for (Gm = 0; Gm < nirreps; Gm++) {
                                ...
                                for (m = 0; m < occpi[Gm]; m++) {
                                    ...
                                    if (nrows && ncols)
                                        C_DGEMV('n', nrows, ncols, -1.0, W2[Ga][0], ncols, T2AB.matrix[Gmk][mk], 1, 1.0,
                                                &(ZLMAO.matrix[Gij][ij][am]), occpi[Gm]);
                                }
                            }
                            ...
                            for (Gm = 0; Gm < nirreps; Gm++) {
                                ...
                                for (m = 0; m < occpi[Gm]; m++) {
                                    ...
                                    if (nrows && ncols)
                                        C_DGEMV('n', nrows, ncols, -1.0, W2[Ga][0], ncols, T2AB.matrix[Gmj][mj], 1, 1.0,
                                                &(ZLmAo.matrix[Gik][ik][am]), occpi[Gm]);
                                }
                            }
                            ...
                            for (Gm = 0; Gm < nirreps; Gm++) {
                                ...
                                for (m = 0; m < occpi[Gm]; m++) {
                                    ...
                                    if (nrows && ncols)
                                        C_DGEMV('n', nrows, ncols, -1.0, W2[Gb][0], ncols, T2AB.matrix[Gmk][mk], 1, 1.0,
                                                &(ZIMLE.matrix[Gij][ij][mb]), 1);
                                }
                            }
                            ...
                            for (Gm = 0; Gm < nirreps; Gm++) {
                                ...
                                for (m = 0; m < occpi[Gm]; m++) {
                                    ...
                                    if (nrows && ncols)
                                        C_DGEMV('t', nrows, ncols, 0.5, W1[Gab][0], ncols, T2AA.matrix[Gmj][mj], 1, 1.0,
                                                &(ZImlE.matrix[Gki][ki][mc]), 1);
                                }
                            }
                            ...
                            for (Gm = 0; Gm < nirreps; Gm++) {
                                ...
                                for (m = 0; m < occpi[Gm]; m++) {
                                    ...
                                    if (nrows && ncols)
                                        C_DGEMV('n', nrows, ncols, -1.0, W2[Gb][0], ncols, T2AB.matrix[Gjm][jm], 1, 1.0,
                                                &(ZImlE.matrix[Gik][ik][mb]), 1);
                                }
                            }
