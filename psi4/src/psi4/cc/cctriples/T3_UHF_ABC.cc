...
void T3_UHF_AAA_abc(double ***W, double ***V, int disc, int nirreps, int A, int Ga, int B, int Gb, int C, int Gc,
    ...
    dabc = 0.0;
    if (fAB->params->rowtot[Ga]) dabc -= fAB->matrix[Ga][a][a];
    if (fAB->params->rowtot[Gb]) dabc -= fAB->matrix[Gb][b][b];
    if (fAB->params->rowtot[Gc]) dabc -= fAB->matrix[Gc][c][c];
    ...
    for (Gd = 0; Gd < nirreps; Gd++) {
        ...
        if (nrows && ncols && nlinks) {
            ...
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, C2->matrix[Gcd][0], nrows, &(F->matrix[Gab][ab][kd]), nlinks,
                    1.0, W[Gij][0], ncols);
        ...
        if (nrows && ncols && nlinks) {
            ...
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, C2->matrix[Gbd][0], nrows, &(F->matrix[Gca][ca][kd]), nlinks,
                    1.0, W[Gij][0], ncols);
        ...
        if (nrows && ncols && nlinks) {
            ...
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, C2->matrix[Gad][0], nrows, &(F->matrix[Gcb][cb][kd]), nlinks,
                    1.0, W[Gij][0], ncols);
    ...
    for (Gl = 0; Gl < nirreps; ++Gl) {
        ...
        if (nrows && ncols && nlinks) {
            ...
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, E->matrix[Gcl][0], nrows, &(C2->matrix[Gab][ab][kl]), nlinks,
                    1.0, W[Gij][0], ncols);
        ...
        if (nrows && ncols && nlinks) {
            ...
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, E->matrix[Gbl][0], nrows, &(C2->matrix[Gca][ca][kl]), nlinks,
                    1.0, W[Gij][0], ncols);
        ...
        if (nrows && ncols && nlinks) {
            ...
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, E->matrix[Gal][0], nrows, &(C2->matrix[Gcb][cb][kl]), nlinks,
                    1.0, W[Gij][0], ncols);
    ...
    for (Gd = 0; Gd < nirreps; Gd++) {
        ...
        if (nrows && ncols && nlinks) {
            C2->matrix[Gcd] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(C2, Gcd, cd, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, C2->matrix[Gcd][0], nrows, &(F->matrix[Gab][ab][jd]), nlinks,
                    1.0, W2[Gik][0], ncols);
            global_dpd_->free_dpd_block(C2->matrix[Gcd], nlinks, nrows);
        }
        ...
        if (nrows && ncols && nlinks) {
            C2->matrix[Gbd] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(C2, Gbd, bd, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, C2->matrix[Gbd][0], nrows, &(F->matrix[Gca][ca][jd]), nlinks,
                    1.0, W2[Gik][0], ncols);
            global_dpd_->free_dpd_block(C2->matrix[Gbd], nlinks, nrows);
        }
        ...
        if (nrows && ncols && nlinks) {
            C2->matrix[Gad] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(C2, Gad, ad, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, C2->matrix[Gad][0], nrows, &(F->matrix[Gbc][bc][jd]), nlinks,
                    1.0, W2[Gik][0], ncols);
            global_dpd_->free_dpd_block(C2->matrix[Gad], nlinks, nrows);
        }
    } /* Gd */
    ...
    for (Gl = 0; Gl < nirreps; ++Gl) {
        ...
        if (nrows && ncols && nlinks) {
            E->matrix[Gcl] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(E, Gcl, cl, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, E->matrix[Gcl][0], nrows, &(C2->matrix[Gab][ab][jl]), nlinks,
                    1.0, W2[Gik][0], ncols);
            global_dpd_->free_dpd_block(E->matrix[Gcl], nlinks, nrows);
        }
        global_dpd_->buf4_mat_irrep_close(C2, Gab);
        ...
        if (nrows && ncols && nlinks) {
            E->matrix[Gbl] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(E, Gbl, bl, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, E->matrix[Gbl][0], nrows, &(C2->matrix[Gca][ca][jl]), nlinks,
                    1.0, W2[Gik][0], ncols);
            global_dpd_->free_dpd_block(E->matrix[Gbl], nlinks, nrows);
        }
        global_dpd_->buf4_mat_irrep_close(C2, Gca);
        ...
        if (nrows && ncols && nlinks) {
            E->matrix[Gal] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(E, Gal, al, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, E->matrix[Gal][0], nrows, &(C2->matrix[Gcb][cb][jl]), nlinks,
                    1.0, W2[Gik][0], ncols);
            global_dpd_->free_dpd_block(E->matrix[Gal], nlinks, nrows);
        }
        global_dpd_->buf4_mat_irrep_close(C2, Gcb);
    ...
    // Sort W2[ik][j]->W[ij][k]
    global_dpd_->sort_3d(W2, W, nirreps, Gabc ^ GX3, C2->params->coltot, C2->params->colidx, C2->params->colorb,
                         C2->params->rsym, C2->params->ssym, occ_off, occ_off, occpi, occ_off, C2->params->colidx, acb,
                         1);
    ...
    for (Gd = 0; Gd < nirreps; Gd++) {
        ...
        if (nrows && ncols && nlinks) {
            C2->matrix[Gcd] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(C2, Gcd, cd, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, C2->matrix[Gcd][0], nrows, &(F->matrix[Gab][ab][id]), nlinks,
                    1.0, W2[Gjk][0], ncols);
            global_dpd_->free_dpd_block(C2->matrix[Gcd], nlinks, nrows);
        }
        ...
        if (nrows && ncols && nlinks) {
            C2->matrix[Gbd] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(C2, Gbd, bd, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, C2->matrix[Gbd][0], nrows, &(F->matrix[Gca][ca][id]), nlinks,
                    1.0, W2[Gjk][0], ncols);
            global_dpd_->free_dpd_block(C2->matrix[Gbd], nlinks, nrows);
        }
        ...
        if (nrows && ncols && nlinks) {
            C2->matrix[Gad] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(C2, Gad, ad, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, C2->matrix[Gad][0], nrows, &(F->matrix[Gcb][cb][id]), nlinks,
                    1.0, W2[Gjk][0], ncols);
            global_dpd_->free_dpd_block(C2->matrix[Gad], nlinks, nrows);
        }
    } /* Gd */
    ...
    for (Gl = 0; Gl < nirreps; Gl++) {
        ...
        if (nrows && ncols && nlinks) {
            E->matrix[Gcl] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(E, Gcl, cl, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, E->matrix[Gcl][0], nrows, &(C2->matrix[Gab][ab][il]), nlinks,
                    1.0, W2[Gjk][0], ncols);
            global_dpd_->free_dpd_block(E->matrix[Gcl], nlinks, nrows);
        }
        global_dpd_->buf4_mat_irrep_close(C2, Gab);
        ...
        if (nrows && ncols && nlinks) {
            E->matrix[Gbl] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(E, Gbl, bl, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, E->matrix[Gbl][0], nrows, &(C2->matrix[Gca][ca][il]), nlinks,
                    1.0, W2[Gjk][0], ncols);
            global_dpd_->free_dpd_block(E->matrix[Gbl], nlinks, nrows);
        }
        global_dpd_->buf4_mat_irrep_close(C2, Gca);
        ...
        if (nrows && ncols && nlinks) {
            E->matrix[Gal] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(E, Gal, al, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, E->matrix[Gal][0], nrows, &(C2->matrix[Gcb][cb][il]), nlinks,
                    1.0, W2[Gjk][0], ncols);
            global_dpd_->free_dpd_block(E->matrix[Gal], nlinks, nrows);
        }
        global_dpd_->buf4_mat_irrep_close(C2, Gcb);
    ...
    // Sort W2[jk][i]->W[ij][k]
    global_dpd_->sort_3d(W2, W, nirreps, Gabc ^ GX3, C2->params->coltot, C2->params->colidx, C2->params->colorb,
                         C2->params->rsym, C2->params->ssym, occ_off, occ_off, occpi, occ_off, C2->params->colidx, cab,
                         1);
...
void T3_UHF_AAB_abc(double ***W, double ***V, int disc, int nirreps, int A, int Ga, int B, int Gb, int C, int Gc,
    ...
    for (Gd = 0; Gd < nirreps; Gd++) {
        ...
        if (nrows && ncols && nlinks) {
            ...
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, T2AA->matrix[Gad][0], nrows, &(FBA->matrix[Gcb][cb][kd]),
                    nlinks, 1.0, W[Gij][0], ncols);
        ...
        if (nrows && ncols && nlinks) {
            ...
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, T2AA->matrix[Gbd][0], nrows, &(FBA->matrix[Gca][ca][kd]),
                    nlinks, 1.0, W[Gij][0], ncols);
    ...
    for (Gl = 0; Gl < nirreps; ++Gl) {
        ...
        if (nrows && ncols && nlinks) {
            ...
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, EAA->matrix[Gal][0], nrows, &(T2BA->matrix[Gcb][cb][kl]),
                    nlinks, 1.0, W[Gij][0], ncols);
        ...
        if (nrows && ncols && nlinks) {
            ...
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, EAA->matrix[Gbl][0], nrows, &(T2BA->matrix[Gca][ca][kl]),
                    nlinks, 1.0, W[Gij][0], ncols);
    ...
    for (Gd = 0; Gd < nirreps; ++Gd) {
        ...
        if (nrows && ncols && nlinks) {
            ...
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, T2AB->matrix[Gbd][0], nrows, &(FAB->matrix[Gac][ac][jd]),
                    nlinks, 1.0, W2[Gik][0], ncols);
        ...
        if (nrows && ncols && nlinks) {
            ...
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, T2AB->matrix[Gad][0], nrows, &(FAB->matrix[Gbc][bc][jd]),
                    nlinks, 1.0, W2[Gik][0], ncols);
    ...
    for (Gl = 0; Gl < nirreps; ++Gl) {
        ...
        if (nrows && ncols && nlinks) {
            ...
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, EAB->matrix[Gcl][0], nrows, &(T2AA->matrix[Gab][ab][jl]),
                    nlinks, 1.0, W2[Gik][0], ncols);
    ...
    /*=== Sort W2[Ik][J] -> W[IJ][k] ===*/
    global_dpd_->sort_3d(W2, W, nirreps, Gabc ^ GX3, T2AB->params->coltot, T2AB->params->colidx, T2AB->params->colorb,
                         T2AB->params->rsym, T2AB->params->ssym, aocc_off, bocc_off, aoccpi, aocc_off,
    ...
    for (Gl = 0; Gl < nirreps; ++Gl) {
        ...
        if (nrows && ncols && nlinks) {
            ...
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, EBA->matrix[Gbl][0], nrows, &(T2AB->matrix[Gac][ac][il]),
                    nlinks, 1.0, W2[Gkj][0], ncols);
        ...
        if (nrows && ncols && nlinks) {
            ...
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, EBA->matrix[Gal][0], nrows, &(T2AB->matrix[Gbc][bc][il]),
                    nlinks, 1.0, W2[Gkj][0], ncols);
    ...
    /*=== Sort W2[kJ][I] -> W[IJ][k] ===*/
    global_dpd_->sort_3d(W2, W, nirreps, Gabc ^ GX3, T2BA->params->coltot, T2BA->params->colidx, T2BA->params->colorb,
                         T2BA->params->rsym, T2BA->params->ssym, bocc_off, aocc_off, aoccpi, aocc_off,
    ...
    for (Gd = 0; Gd < nirreps; ++Gd) {
        ...
        if (nrows && ncols && nlinks) {
            ...
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, T2BA->matrix[Gcd][0], nrows, &(FAA->matrix[Gab][ab][jd]),
                    nlinks, 1.0, W2[Gki][0], ncols);
    ...
    for (Gl = 0; Gl < nirreps; ++Gl) {
        ...
        if (nrows && ncols && nlinks) {
            EBA->matrix[Gal] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(EBA, Gal, al, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, EBA->matrix[Gal][0], nrows, &(T2AB->matrix[Gbc][bc][jl]),
                    nlinks, 1.0, W2[Gki][0], ncols);
            global_dpd_->free_dpd_block(EBA->matrix[Gal], nlinks, nrows);
        }
        global_dpd_->buf4_mat_irrep_close(T2AB, Gbc);
        ...
        if (nrows && ncols && nlinks) {
            EBA->matrix[Gbl] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(EBA, Gbl, bl, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, EBA->matrix[Gbl][0], nrows, &(T2AB->matrix[Gac][ac][jl]),
                    nlinks, 1.0, W2[Gki][0], ncols);
            global_dpd_->free_dpd_block(EBA->matrix[Gbl], nlinks, nrows);
        }
        global_dpd_->buf4_mat_irrep_close(T2AB, Gac);
    ...
    for (Gd = 0; Gd < nirreps; ++Gd) {
        ...
        if (nrows && ncols && nlinks) {
            T2BA->matrix[Gcd] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(T2BA, Gcd, cd, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, T2BA->matrix[Gcd][0], nrows, &(FAA->matrix[Gab][ab][id]),
                    nlinks, 1.0, W2[Gkj][0], ncols);
            global_dpd_->free_dpd_block(T2BA->matrix[Gcd], nlinks, nrows);
        }
    } /* Gd */
    ...
    for (Gd = 0; Gd < nirreps; ++Gd) {
        ...
        if (nrows && ncols && nlinks) {
            T2AB->matrix[Gbd] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(T2AB, Gbd, bd, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, T2AB->matrix[Gbd][0], nrows, &(FAB->matrix[Gac][ac][id]),
                    nlinks, 1.0, W2[Gjk][0], ncols);
            global_dpd_->free_dpd_block(T2AB->matrix[Gbd], nlinks, nrows);
        }
        ...
        if (nrows && ncols && nlinks) {
            T2AB->matrix[Gad] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(T2AB, Gad, ad, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, T2AB->matrix[Gad][0], nrows, &(FAB->matrix[Gbc][bc][id]),
                    nlinks, 1.0, W2[Gjk][0], ncols);
            global_dpd_->free_dpd_block(T2AB->matrix[Gad], nlinks, nrows);
        }
    } /* Gd */
    ...
    for (Gl = 0; Gl < nirreps; ++Gl) {
        ...
        if (nrows && ncols && nlinks) {
            EAB->matrix[Gcl] = global_dpd_->dpd_block_matrix(nlinks, nrows);
            global_dpd_->buf4_mat_irrep_rd_block(EAB, Gcl, cl, nlinks);
            C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, EAB->matrix[Gcl][0], nrows, &(T2AA->matrix[Gab][ab][il]),
                    nlinks, 1.0, W2[Gjk][0], ncols);
            global_dpd_->free_dpd_block(EAB->matrix[Gcl], nlinks, nrows);
        }
        global_dpd_->buf4_mat_irrep_close(T2AA, Gab);
