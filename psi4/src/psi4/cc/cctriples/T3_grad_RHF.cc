                            ...
                            */
                                    ...
                                    if (Gi == Ga && S1.params->rowtot[Gi] && S1.params->coltot[Gi]) {
                                        for (c = 0; c < virtpi[Gc]; c++) {
                                            ...
                                            value = (4 * W0[Gab][ab][c] + W0[Gbc][bc][a] + W0[Gca][ca][b] -
                                                     3 * W0[Gcb][cb][a] - 2 * W0[Gac][ac][b] - W0[Gba][ba][c]) /
                                                    denom;
                            ...
                            for (Gd = 0; Gd < nirreps; Gd++) {
                                ...
                                if (nrows && ncols && nlinks) {
                                    ...
                                    C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, M[Gab][0], nrows, Fints.matrix[Gid][0],
                                            nlinks, 1.0, &(S2.matrix[Gkj][kj][cd]), ncols);
                        ...
                        for (c = 0; c < virtpi[Gc]; c++) {
                            ...
                            for (Gd = 0; Gd < nirreps; Gd++) {
                                ...
                                if (nrows && ncols && nlinks && W0[Gij] != nullptr)
                                    C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(T2i.matrix[Gad][ad][0]), nrows,
                                            &(F3ints.matrix[Gcb][cb][kd]), nlinks, 0.0, &(W0[Gij][0][0]), ncols);
                            }
                            ...
                            for (Gl = 0; Gl < nirreps; Gl++) {
                                ...
                                if (nrows && ncols && nlinks && W0[Gij] != nullptr) {
                                    E2ints.matrix[Gal] =
                                        global_dpd_->dpd_block_matrix(occpi[Gl], E2ints.params->coltot[Gal]);
                                    global_dpd_->buf4_mat_irrep_rd_block(&E2ints, Gal, E2ints.row_offset[Gal][A],
                                                                         occpi[Gl]);

                                    C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, &(E2ints.matrix[Gal][0][0]), nrows,
                                            &(T2i.matrix[Gcb][cb][kl]), nlinks, 1.0, &(W0[Gij][0][0]), ncols);

                                    global_dpd_->free_dpd_block(E2ints.matrix[Gal], occpi[Gl],
                                                                E2ints.params->coltot[Gal]);
                                }
                            }
                            /* Sort W[ij][k] --> W[ik][j] */
                            global_dpd_->sort_3d(W0, W1, nirreps, Gabc, Eints.params->rowtot, Eints.params->rowidx,
                                                 Eints.params->roworb, Eints.params->psym, Eints.params->qsym, occ_off,
                                                 occ_off, occpi, occ_off, Eints.params->rowidx, acb, 0);
                            ...
                            for (Gd = 0; Gd < nirreps; Gd++) {
                                ...
                                if (nrows && ncols && nlinks && W1[Gik] != nullptr)
                                    C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(T2i.matrix[Gad][ad][0]), nrows,
                                            &(F3ints.matrix[Gbc][bc][jd]), nlinks, 1.0, &(W1[Gik][0][0]), ncols);
                            }
                            ...
                            for (Gl = 0; Gl < nirreps; Gl++) {
                                ...
                                if (nrows && ncols && nlinks && W1[Gik] != nullptr) {
                                    ...
                                    C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, &(E2ints.matrix[Gal][0][0]), nrows,
                                            &(T2i.matrix[Gbc][bc][jl]), nlinks, 1.0, &(W1[Gik][0][0]), ncols);
                            ...
                            global_dpd_->sort_3d(W1, W0, nirreps, Gabc, Eints.params->rowtot, Eints.params->rowidx,
                                                 Eints.params->roworb, Eints.params->psym, Eints.params->qsym, occ_off,
                                                 occ_off, occpi, occ_off, Eints.params->rowidx, bac, 0);
                            ...
                            for (Gd = 0; Gd < nirreps; Gd++) {
                                ...
                                if (nrows && ncols && nlinks && W0[Gki] != nullptr)
                                    C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(T2i.matrix[Gcd][cd][0]), nrows,
                                            &(F3ints.matrix[Gba][ba][jd]), nlinks, 1.0, &(W0[Gki][0][0]), ncols);
                            }
                            ...
                            for (Gl = 0; Gl < nirreps; Gl++) {
                                ...
                                if (nrows && ncols && nlinks && W0[Gki] != nullptr) {
                                    E2ints.matrix[Gcl] =
                                        global_dpd_->dpd_block_matrix(occpi[Gl], E2ints.params->coltot[Gcl]);
                                    global_dpd_->buf4_mat_irrep_rd_block(&E2ints, Gcl, E2ints.row_offset[Gcl][C],
                                                                         occpi[Gl]);

                                    C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, &(E2ints.matrix[Gcl][0][0]), nrows,
                                            &(T2i.matrix[Gba][ba][jl]), nlinks, 1.0, &(W0[Gki][0][0]), ncols);

                                    global_dpd_->free_dpd_block(E2ints.matrix[Gcl], occpi[Gl],
                                                                E2ints.params->coltot[Gcl]);
                                }
                            }
                            /* Sort W[ki][j] --> W[kj][i] */
                            global_dpd_->sort_3d(W0, W1, nirreps, Gabc, Eints.params->rowtot, Eints.params->rowidx,
                            ...
                            for (Gd = 0; Gd < nirreps; Gd++) {
                                ...
                                if (nrows && ncols && nlinks && W1[Gkj] != nullptr)
                                    C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(T2i.matrix[Gcd][cd][0]), nrows,
                                            &(F3ints.matrix[Gab][ab][id]), nlinks, 1.0, &(W1[Gkj][0][0]), ncols);
                            }
                            ...
                            for (Gl = 0; Gl < nirreps; Gl++) {
                                ...
                                if (nrows && ncols && nlinks && W1[Gkj] != nullptr) {
                                    ...
                                    C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, &(E2ints.matrix[Gcl][0][0]), nrows,
                                            &(T2i.matrix[Gab][ab][il]), nlinks, 1.0, &(W1[Gkj][0][0]), ncols);
                            ...
                            for (Gd = 0; Gd < nirreps; Gd++) {
                                ...
                                if (nrows && ncols && nlinks && W0[Gjk] != nullptr)
                                    C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(T2i.matrix[Gbd][bd][0]), nrows,
                                            &(F3ints.matrix[Gac][ac][id]), nlinks, 1.0, &(W0[Gjk][0][0]), ncols);
                            }
                            ...
                            for (Gl = 0; Gl < nirreps; Gl++) {
                                ...
                                if (nrows && ncols && nlinks && W0[Gjk] != nullptr) {
                                    E2ints.matrix[Gbl] =
                                        global_dpd_->dpd_block_matrix(occpi[Gl], E2ints.params->coltot[Gbl]);
                                    global_dpd_->buf4_mat_irrep_rd_block(&E2ints, Gbl, E2ints.row_offset[Gbl][B],
                                                                         occpi[Gl]);

                                    C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, &(E2ints.matrix[Gbl][0][0]), nrows,
                                            &(T2i.matrix[Gac][ac][il]), nlinks, 1.0, &(W0[Gjk][0][0]), ncols);

                                    global_dpd_->free_dpd_block(E2ints.matrix[Gbl], occpi[Gl],
                                                                E2ints.params->coltot[Gbl]);
                                }
                            }
                            /* Sort W[jk][i] --> W[ji][k] */
                            global_dpd_->sort_3d(W0, W1, nirreps, Gabc, Eints.params->rowtot, Eints.params->rowidx,
                            ...
                            for (Gd = 0; Gd < nirreps; Gd++) {
                                ...
                                if (nrows && ncols && nlinks && W1[Gji] != nullptr)
                                    C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(T2i.matrix[Gbd][bd][0]), nrows,
                                            &(F3ints.matrix[Gca][ca][kd]), nlinks, 1.0, &(W1[Gji][0][0]), ncols);
                            }
                            ...
                            for (Gl = 0; Gl < nirreps; Gl++) {
                                ...
                                if (nrows && ncols && nlinks && W1[Gji] != nullptr) {
                                    ...
                                    C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, &(E2ints.matrix[Gbl][0][0]), nrows,
                                            &(T2i.matrix[Gca][ca][kl]), nlinks, 1.0, &(W1[Gji][0][0]), ncols);
                          ...
                          */
                            ...
                            for (Gij = 0; Gij < nirreps; Gij++) {
                                ...
                                for (ij = 0; ij < Eints.params->rowtot[Gij]; ij++) {
                                    ...
                                    for (k = 0; k < occpi[Gk]; k++) {
                                        ...
                                        /* TJ Lee Expression */
                                        M[Gij][ij][k] = 2 *
                                                        (8 * W0[Gij][ij][k] + 2 * W0[Gjk][jk][i] + 2 * W0[Gki][ki][j] -
                                                         4 * W0[Gkj][kj][i] - 4 * W0[Gik][ik][j] - 4 * W0[Gji][ji][k] +
                                                         4 * V[Gij][ij][k] + V[Gjk][jk][i] + V[Gki][ki][j] -
                                                         2 * V[Gkj][kj][i] - 2 * V[Gik][ik][j] - 2 * V[Gji][ji][k]) /
                                                        denom;
                            ...
                            for (Gil = 0; Gil < nirreps; Gil++) {
                                ...
                                if (nrows && ncols && nlinks) {
                                    E2ints.matrix[Gil] =
                                        global_dpd_->dpd_block_matrix(occpi[Gj], E2ints.params->coltot[Gil]);
                                    ...
                                    global_dpd_->free_dpd_block(E2ints.matrix[Gil], occpi[Gj],
                                                                E2ints.params->coltot[Gil]);
                                }
                            } /* Gil */
