...
#pragma omp critical
                    ...
                    if (nrows && ncols && nlinks) {
                        ...
                        C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(Fints->matrix[Gid][0][0]), nrows,
                                &(L2->matrix[Gkj][kj][cd]), nlinks, 0.0, &(W2[Gab][0][0]), ncols);
                    }
                ...
                for (Gl = 0; Gl < nirreps; Gl++) {
                    ...
                    if (nrows && ncols && nlinks) {
                        ...
                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L2->matrix[Gil][il][0]), nrows,
                                &(Eints->matrix[Gjk][jk][lc]), ncols, 1.0, &(W2[Gab][0][0]), ncols);
                    }
                }

                /* Sort W[ab][c] --> W[ac][b] */
                global_dpd_->sort_3d(W0, W1, nirreps, Gijk, Fints->params->coltot, Fints->params->colidx,
                                     Fints->params->colorb, Fints->params->rsym, Fints->params->ssym, vir_off, vir_off,
                                     virtpi, vir_off, Fints->params->colidx, acb, 0);
...
#pragma omp critical
                    ...
                    if (nrows && ncols && nlinks) {
                        ...
                        C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(Fints->matrix[Gid][0][0]), nrows,
                                &(L2->matrix[Gjk][jk][bd]), nlinks, 1.0, &(W3[Gac][0][0]), ncols);
                    }
                ...
                for (Gl = 0; Gl < nirreps; Gl++) {
                    ...
                    if (nrows && ncols && nlinks) {
                        ...
                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L2->matrix[Gil][il][0]), nrows,
                                &(Eints->matrix[Gkj][kj][lb]), ncols, 1.0, &(W3[Gac][0][0]), ncols);
                    }
                }
                ...
                global_dpd_->sort_3d(W1, W0, nirreps, Gijk, Fints->params->coltot, Fints->params->colidx,
                                     Fints->params->colorb, Fints->params->rsym, Fints->params->ssym, vir_off, vir_off,
                                     virtpi, vir_off, Fints->params->colidx, bac, 0);
...
#pragma omp critical
                    ...
                    if (nrows && ncols && nlinks) {
                        ...
                        C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(Fints->matrix[Gkd][0][0]), nrows,
                                &(L2->matrix[Gji][ji][bd]), nlinks, 1.0, &(W2[Gca][0][0]), ncols);
                    }
                ...
                for (Gl = 0; Gl < nirreps; Gl++) {
                    ...
                    if (nrows && ncols && nlinks) {
                        ...
                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L2->matrix[Gkl][kl][0]), nrows,
                                &(Eints->matrix[Gij][ij][lb]), ncols, 1.0, &(W2[Gca][0][0]), ncols);
                    }
                }
...
#pragma omp critical
                    ...
                    if (nrows && ncols && nlinks) {
                        ...
                        C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(Fints->matrix[Gkd][0][0]), nrows,
                                &(L2->matrix[Gij][ij][ad]), nlinks, 1.0, &(W3[Gcb][0][0]), ncols);
                    }
                ...
                for (Gl = 0; Gl < nirreps; Gl++) {
                    ...
                    if (nrows && ncols && nlinks) {
                        ...
                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L2->matrix[Gkl][kl][0]), nrows,
                                &(Eints->matrix[Gji][ji][la]), ncols, 1.0, &(W3[Gcb][0][0]), ncols);
                    }
                }
...
#pragma omp critical
                    ...
                    if (nrows && ncols && nlinks) {
                        ...
                        C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(Fints->matrix[Gjd][0][0]), nrows,
                                &(L2->matrix[Gik][ik][ad]), nlinks, 1.0, &(W2[Gbc][0][0]), ncols);
                    }
                ...
                for (Gl = 0; Gl < nirreps; Gl++) {
                    ...
                    if (nrows && ncols && nlinks) {
                        ...
                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L2->matrix[Gjl][jl][0]), nrows,
                                &(Eints->matrix[Gki][ki][la]), ncols, 1.0, &(W2[Gbc][0][0]), ncols);
                    }
                }
...
#pragma omp critical
                    ...
                    if (nrows && ncols && nlinks) {
                        ...
                        C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(Fints->matrix[Gjd][0][0]), nrows,
                                &(L2->matrix[Gki][ki][cd]), nlinks, 1.0, &(W3[Gba][0][0]), ncols);
                    }
                ...
                for (Gl = 0; Gl < nirreps; Gl++) {
                    ...
                    if (nrows && ncols && nlinks) {
                        ...
                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L2->matrix[Gjl][jl][0]), nrows,
                                &(Eints->matrix[Gik][ik][lc]), ncols, 1.0, &(W3[Gba][0][0]), ncols);
                    }
                }
