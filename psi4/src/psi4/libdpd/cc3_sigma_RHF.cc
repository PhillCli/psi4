                ...
                for (i = 0; i < occpi[Gi]; i++) {
                    ...
                    for (j = 0; j < occpi[Gj]; j++) {
                        ...
                        for (k = 0; k < occpi[Gk]; k++) {
                            ...
                            timer_on("T3_RHF");
#endif
                            T3_RHF(W3, nirreps, I, Gi, J, Gj, K, Gk, CIjAb, WAbEi, WMbIj, &fIJ2, &fAB2, occpi, occ_off,
                   ...
                   as this non-symmetric case does not arise for CC3 EOM energies */
                                ...
                                if (newtrips) {
                                    ...
                                    if (nrows && ncols)
                                        C_DGEMV('n', nrows, ncols, 1.0, Va[Ga][0], ncols, &(Dints->matrix[Gjk][jk][0]),
                                                1, 1.0, SIA_inc.matrix[Gi][i], 1);
                                    ...
                                    if (nrows && ncols)
                                        C_DGEMV('n', nrows, ncols, 1.0, W3a[Ga][0], ncols, &(Dints->matrix[Gjk][jk][0]),
                                                1, 1.0, SIA_inc.matrix[Gi][i], 1);
                            ...
                            if (do_doubles) {
                                ...
                                if (newtrips) {
                                    ...
                                    if (nrows && ncols) {
                                        ...
                                        C_DGEMV('n', nrows, ncols, 1.0, V[Gab][0], ncols, FME->matrix[Gk][k], 1, 0.0,
                                                tvect, 1);
                                    ...
                                    for (Gd = 0; Gd < nirreps; Gd++) {
                                        ...
                                        if (nrows && ncols && nlinks) {
                                            ...
                                            WmAEf->matrix[Gkd] =
                                                dpd_block_matrix(virtpi[Gd], WmAEf->params->coltot[Gkd ^ GW]);
                                            buf4_mat_irrep_rd_block(WmAEf, Gkd, kd, virtpi[Gd]);

                                            Z = dpd_block_matrix(virtpi[Ga], virtpi[Gd]);
                                            C_DGEMM('n', 't', nrows, ncols, nlinks, 1.0, Wa[Ga][0], nlinks,
                                            ...
                                            free_dpd_block(WmAEf->matrix[Gkd], virtpi[Gd],
                                                           WmAEf->params->coltot[Gkd ^ GW]);
                                        }
                                    }
                                    ...
                                    if (nrows && ncols) {
                                        tvect = init_array(nrows);
                                        C_DGEMV('n', nrows, ncols, 1.0, W3[Gab][0], ncols, FME->matrix[Gk][k], 1, 0.0,
                                                tvect, 1);
                                    ...
                                    if (nrows && ncols) {
                                        tvect = init_array(nrows);
                                        C_DGEMV('n', nrows, ncols, 1.0, W3[Gab][0], ncols, FME->matrix[Gi][i], 1, 0.0,
                                                tvect, 1);
                                    ...
                                    for (Gd = 0; Gd < nirreps; Gd++) {
                                        ...
                                        if (nrows && ncols && nlinks) {
                                            ...
                                            WmAEf->matrix[Gid] =
                                                dpd_block_matrix(virtpi[Gd], WmAEf->params->coltot[Gid ^ GW]);
                                            ...
                                            free_dpd_block(Z, virtpi[Ga], virtpi[Gd]);
                                            free_dpd_block(WmAEf->matrix[Gid], virtpi[Gd],
                                                           WmAEf->params->coltot[Gid ^ GW]);
                                        }
                                    }
                                    ...
                                    for (Gd = 0; Gd < nirreps; Gd++) {
                                        ...
                                        if (nrows && ncols && nlinks) {
                                            ...
                                            WmAEf->matrix[Gjd] =
                                                dpd_block_matrix(virtpi[Gd], WmAEf->params->coltot[Gjd ^ GW]);
                                            ...
                                            free_dpd_block(Z, virtpi[Ga], virtpi[Gd]);
                                            free_dpd_block(WmAEf->matrix[Gjd], virtpi[Gd],
                                                           WmAEf->params->coltot[Gjd ^ GW]);
                                        }
                                    }
