...
void CoupledCluster::I2iabj_quadratic(CCTaskParams params) {
    ...
    for (i = 0; i < o; i++) {
        for (b = 0; b < v; b++) {
            for (j = 0; j < o; j++) {
                C_DAXPY(v, -0.5, tempt + i * v * v * o + j * v + b, v * o, tempv + i * o * v * v + b * o * v + j * v,
                        1);
            }
        }
    }
...
void CoupledCluster::I2iajb_quadratic(CCTaskParams params) {
    ...
    for (a = 0; a < v; a++) {
        for (b = 0; b < v; b++) {
            for (i = 0; i < o; i++) {
                C_DAXPY(o, 1.0, tempv + b * v * o + i * v + a, o * v * v, integrals + a * o * o * v + b * o * o + i * o,
                        1);
                C_DAXPY(o, 1.0, tempv + i * o * v * v + a * v * o + b, v, integrals + a * o * o * v + b * o * o + i * o,
                        1);
            }
        }
    }
    ...
    for (a = 0; a < v; a++) {
        for (b = 0; b < v; b++) {
            for (j = 0; j < o; j++) {
                C_DAXPY(o, 1.0, integrals + j * o * v * v + b * v * o + a, v, tempv + a * o * o * v + b * o * o + j * o,
                        1);
                C_DAXPY(o, 1.0, integrals + a * v * o + j * v + b, o * v * v, tempv + a * o * o * v + b * o * o + j * o,
                        1);
            }
        }
    }
