                ...
                for (long int a = 0; a < navirA; a++) {
                    ...
                    for (long int b = 0; b < a; b++) {
                        ...
                        for (long int c = 0; c < b; c++) {
                            ...
                            // Vijkabc = t1A->get(k, c) * G_IJAB->get(ij, ab) + t2AA->get(ij, ab) * FockA->get(nfrzc +
                            // k, noccA + c)
                            //        - t1A->get(i, c) * G_IJAB->get(kj, ab) - t2AA->get(kj, ab) * FockA->get(nfrzc + i,
                            //        noccA + c)
                            //        - t1A->get(j, c) * G_IJAB->get(ik, ab) - t2AA->get(ik, ab) * FockA->get(nfrzc + j,
                            //        noccA + c)
                            //        - t1A->get(k, a) * G_IJAB->get(ij, cb) - t2AA->get(ij, cb) * FockA->get(nfrzc + k,
                            //        noccA + a)
                            //        + t1A->get(i, a) * G_IJAB->get(kj, cb) + t2AA->get(kj, cb) * FockA->get(nfrzc + i,
                            //        noccA + a)
                            //        + t1A->get(j, a) * G_IJAB->get(ik, cb) + t2AA->get(ik, cb) * FockA->get(nfrzc + j,
                            //        noccA + a)
                            //        - t1A->get(k, b) * G_IJAB->get(ij, ac) - t2AA->get(ij, ac) * FockA->get(nfrzc + k,
                            //        noccA + b)
                            //        + t1A->get(i, b) * G_IJAB->get(kj, ac) + t2AA->get(kj, ac) * FockA->get(nfrzc + i,
                            //        noccA + b)
                            //        + t1A->get(j, b) * G_IJAB->get(ik, ac) + t2AA->get(ik, ac) * FockA->get(nfrzc + j,
                            //        noccA + b);
                            ...
                            Vijkabc = l1A->get(k, c) * G_IJAB->get(ij, ab) +
                                      l2AA->get(ij, ab) * FockA->get(nfrzc + k, noccA + c) -
                                      l1A->get(i, c) * G_IJAB->get(kj, ab) -
                                      l2AA->get(kj, ab) * FockA->get(nfrzc + i, noccA + c) -
                                      l1A->get(j, c) * G_IJAB->get(ik, ab) -
                                      l2AA->get(ik, ab) * FockA->get(nfrzc + j, noccA + c) -
                                      l1A->get(k, a) * G_IJAB->get(ij, cb) -
                                      l2AA->get(ij, cb) * FockA->get(nfrzc + k, noccA + a) +
                                      l1A->get(i, a) * G_IJAB->get(kj, cb) +
                                      l2AA->get(kj, cb) * FockA->get(nfrzc + i, noccA + a) +
                                      l1A->get(j, a) * G_IJAB->get(ik, cb) +
                                      l2AA->get(ik, cb) * FockA->get(nfrzc + j, noccA + a) -
                                      l1A->get(k, b) * G_IJAB->get(ij, ac) -
                                      l2AA->get(ij, ac) * FockA->get(nfrzc + k, noccA + b) +
                                      l1A->get(i, b) * G_IJAB->get(kj, ac) +
                                      l2AA->get(kj, ac) * FockA->get(nfrzc + i, noccA + b) +
                                      l1A->get(j, b) * G_IJAB->get(ik, ac) +
                                      l2AA->get(ik, ac) * FockA->get(nfrzc + j, noccA + b);
                ...
                for (long int a = 0; a < navirB; a++) {
                    ...
                    for (long int b = 0; b < a; b++) {
                        ...
                        for (long int c = 0; c < b; c++) {
                            ...
                            //       + t_i^b <kj||ac> - t_kj^ac f_ib
                            //       + t_j^b <ik||ac> - t_ik^ac f_jb
                            // Vijkabc = t1B->get(k, c) * G_ijab->get(ij, ab) + t2BB->get(ij, ab) * FockB->get(nfrzc +
                            // k, noccB + c)
                            //        - t1B->get(i, c) * G_ijab->get(kj, ab) - t2BB->get(kj, ab) * FockB->get(nfrzc + i,
                            //        noccB + c)
                            //        - t1B->get(j, c) * G_ijab->get(ik, ab) - t2BB->get(ik, ab) * FockB->get(nfrzc + j,
                            //        noccB + c)
                            //        - t1B->get(k, a) * G_ijab->get(ij, cb) - t2BB->get(ij, cb) * FockB->get(nfrzc + k,
                            //        noccB + a)
                            //        + t1B->get(i, a) * G_ijab->get(kj, cb) + t2BB->get(kj, cb) * FockB->get(nfrzc + i,
                            //        noccB + a)
                            //        + t1B->get(j, a) * G_ijab->get(ik, cb) + t2BB->get(ik, cb) * FockB->get(nfrzc + j,
                            //        noccB + a)
                            //        - t1B->get(k, b) * G_ijab->get(ij, ac) - t2BB->get(ij, ac) * FockB->get(nfrzc + k,
                            //        noccB + b)
                            //        + t1B->get(i, b) * G_ijab->get(kj, ac) + t2BB->get(kj, ac) * FockB->get(nfrzc + i,
                            //        noccB + b)
                            //        + t1B->get(j, b) * G_ijab->get(ik, ac) + t2BB->get(ik, ac) * FockB->get(nfrzc + j,
                            //        noccB + b);
                            ...
                            //       + l_i^b <kj||ac> - l_kj^ac f_ib
                            //       + l_j^b <ik||ac> - l_ik^ac f_jb
                            Vijkabc = l1B->get(k, c) * G_ijab->get(ij, ab) +
                                      l2BB->get(ij, ab) * FockB->get(nfrzc + k, noccB + c) -
                                      l1B->get(i, c) * G_ijab->get(kj, ab) -
                                      l2BB->get(kj, ab) * FockB->get(nfrzc + i, noccB + c) -
                                      l1B->get(j, c) * G_ijab->get(ik, ab) -
                                      l2BB->get(ik, ab) * FockB->get(nfrzc + j, noccB + c) -
                                      l1B->get(k, a) * G_ijab->get(ij, cb) -
                                      l2BB->get(ij, cb) * FockB->get(nfrzc + k, noccB + a) +
                                      l1B->get(i, a) * G_ijab->get(kj, cb) +
                                      l2BB->get(kj, cb) * FockB->get(nfrzc + i, noccB + a) +
                                      l1B->get(j, a) * G_ijab->get(ik, cb) +
                                      l2BB->get(ik, cb) * FockB->get(nfrzc + j, noccB + a) -
                                      l1B->get(k, b) * G_ijab->get(ij, ac) -
                                      l2BB->get(ij, ac) * FockB->get(nfrzc + k, noccB + b) +
                                      l1B->get(i, b) * G_ijab->get(kj, ac) +
                                      l2BB->get(kj, ac) * FockB->get(nfrzc + i, noccB + b) +
                                      l1B->get(j, b) * G_ijab->get(ik, ac) +
                                      l2BB->get(ik, ac) * FockB->get(nfrzc + j, noccB + b);
    ...
    for (long int i = 0; i < naoccA; i++) {
        ...
        for (long int j = 0; j < i; j++) {
            ...
            for (long int k = 0; k < naoccB; k++) {
                ...
                for (long int A = 0; A < navirA; ++A) {
                    for (long int B = 0; B < navirA; ++B) {
                        Wl_AAB->axpy((size_t)navirB, A * navirA * navirB + B, navirA, Waux,
                                     A * navirA * navirB + B * navirB, 1, 1.0);
                        Wl_AAB->axpy((size_t)navirB, A * navirA * navirB + B, navirA, Waux,
                                     B * navirA * navirB + A * navirB, 1, -1.0);
                    }
                ...
                for (long int A = 0; A < navirA; ++A) {
                    for (long int B = 0; B < navirA; ++B) {
                        Wl_AAB->axpy((size_t)navirB, B * navirA * navirB + A, navirA, Waux,
                                     A * navirA * navirB + B * navirB, 1, 1.0);
                        Wl_AAB->axpy((size_t)navirB, B * navirA * navirB + A, navirA, Waux,
                                     B * navirA * navirB + A * navirB, 1, -1.0);
                    }
                ...
                Wl_AAB->contract(true, false, navir2AA, navirB, navirA, G_I_ABC, l2AB, 0,
                                 (j * naoccB * navirA * navirB) + (k * navirA * navirB), 1.0, 1.0);
                ...
                Wl_AAB->contract(true, false, navir2AA, navirB, naoccA, l2AA, K_IjKa, (j * naoccA * navir2AA),
                                 (i * naoccB * naoccA * navirB) + (k * naoccA * navirB), 1.0, 1.0);

                // Wl_AAB[IJk](AB,c) -= \sum(M) l_IM^AB <Jk|Mc>         (6)
                // Wl_AAB[IJk](AB,c) -= \sum(M) L[I](M,AB) K[Jk](M,c)
                Wl_AAB->contract(true, false, navir2AA, navirB, naoccA, l2AA, K_IjKa, (i * naoccA * navir2AA),
                                 (j * naoccB * naoccA * navirB) + (k * naoccA * navirB), -1.0, 1.0);
                ...
                for (long int A = 0; A < navirA; ++A) {
                    for (long int B = 0; B < navirA; ++B) {
                        Wl_AAB->axpy((size_t)navirB, A * navirA * navirB + B * navirB, 1, Waux,
                                     B * navirA * navirB + A * navirB, 1, -1.0);
                    }
                }
                Waux.reset();
                ...
                for (long int a = 0; a < navirA; a++) {
                    ...
                    for (long int b = 0; b < a; b++) {
                        ...
                        for (long int c = 0; c < navirB; c++) {
                            ...
                            // Vijkabc = t2AB->get(jk, bc) * FockA->get(nfrzc + i, noccA + a) + t1A->get(i, a) *
                            // K_IjAb->get(jk, bc)
                            //        - t2AB->get(ik, bc) * FockA->get(nfrzc + j, noccA + a) - t1A->get(j, a) *
                            //        K_IjAb->get(ik, bc)
                            //        - t2AB->get(jk, ac) * FockA->get(nfrzc + i, noccA + b) - t1A->get(i, b) *
                            //        K_IjAb->get(jk, ac)
                            //        + t2AB->get(ik, ac) * FockA->get(nfrzc + j, noccA + b) + t1A->get(j, b) *
                            //        K_IjAb->get(ik, ac)
                            //        + t2AA->get(ij, ab) * FockB->get(nfrzc + k, noccB + c) + t1B->get(k, c) *
                            //        G_IJAB->get(ij, ab);
                            ...
                            Vijkabc = l2AB->get(jk, bc) * FockA->get(nfrzc + i, noccA + a) +
                                      l1A->get(i, a) * K_IjAb->get(jk, bc) -
                                      l2AB->get(ik, bc) * FockA->get(nfrzc + j, noccA + a) -
                                      l1A->get(j, a) * K_IjAb->get(ik, bc) -
                                      l2AB->get(jk, ac) * FockA->get(nfrzc + i, noccA + b) -
                                      l1A->get(i, b) * K_IjAb->get(jk, ac) +
                                      l2AB->get(ik, ac) * FockA->get(nfrzc + j, noccA + b) +
                                      l1A->get(j, b) * K_IjAb->get(ik, ac) +
                                      l2AA->get(ij, ab) * FockB->get(nfrzc + k, noccB + c) +
                                      l1B->get(k, c) * G_IJAB->get(ij, ab);
    ...
    for (long int i = 0; i < naoccA; i++) {
        ...
        for (long int j = 0; j < naoccB; j++) {
            ...
            for (long int k = 0; k < j; k++) {
                ...
                for (long int A = 0; A < navirA; ++A) {
                    for (long int b = 0; b < navirB; ++b) {
                        Wl_ABB->axpy((size_t)navirB, b * navirA * navirB + A * navirB, 1, Waux, A * navirB * navirB + b,
                                     navirB, 1.0);
                        Wl_ABB->axpy((size_t)navirB, b * navirA * navirB + A * navirB, 1, Waux,
                                     A * navirB * navirB + b * navirB, 1, -1.0);
                    }
                }
                ...
                for (long int A = 0; A < navirA; ++A) {
                    for (long int c = 0; c < navirB; ++c) {
                        Wl_ABB->axpy((size_t)navirB, c * navirA * navirB + A * navirB, 1, Waux,
                                     A * navirB * navirB + c * navirB, 1, 1.0);
                        Wl_ABB->axpy((size_t)navirB, c * navirA * navirB + A * navirB, 1, Waux, A * navirB * navirB + c,
                                     navirB, -1.0);
                    }
                }
                Waux.reset();
                ...
                for (long int A = 0; A < navirA; ++A) {
                    for (long int b = 0; b < navirB; ++b) {
                        Wl_ABB->axpy((size_t)navirB, b * navirB * navirA + A, navirA, Waux, A * navirB * navirB + b,
                                     navirB, 1.0);
                        Wl_ABB->axpy((size_t)navirB, b * navirB * navirA + A, navirA, Waux,
                                     A * navirB * navirB + b * navirB, 1, -1.0);
                    }
                }
                ...
                for (long int A = 0; A < navirA; ++A) {
                    for (long int c = 0; c < navirB; ++c) {
                        Wl_ABB->axpy((size_t)navirB, c * navirB * navirA + A, navirA, Waux,
                                     A * navirB * navirB + c * navirB, 1, 1.0);
                        Wl_ABB->axpy((size_t)navirB, c * navirB * navirA + A, navirA, Waux, A * navirB * navirB + c,
                                     navirB, -1.0);
                    }
                }
                Waux.reset();
                ...
                for (long int a = 0; a < navirA; a++) {
                    ...
                    for (long int b = 0; b < navirB; b++) {
                        ...
                        for (long int c = 0; c < b; c++) {
                            ...
                            // Vijkabc = t2AB->get(ij, ab) * FockB->get(nfrzc + k, noccB + c) + t1B->get(k, c) *
                            // K_IjAb->get(ij, ab)
                            //        - t2AB->get(ik, ab) * FockB->get(nfrzc + j, noccB + c) - t1B->get(j, c) *
                            //        K_IjAb->get(ik, ab)
                            //        - t2AB->get(ij, ac) * FockB->get(nfrzc + k, noccB + b) - t1B->get(k, b) *
                            //        K_IjAb->get(ij, ac)
                            //        + t2AB->get(ik, ac) * FockB->get(nfrzc + j, noccB + b) + t1B->get(j, b) *
                            //        K_IjAb->get(ik, ac)
                            //        + t2BB->get(kj, cb) * FockA->get(nfrzc + i, noccA + a) + t1A->get(i, a) *
                            //        G_ijab->get(kj, cb);
                            ...
                            Vijkabc = l2AB->get(ij, ab) * FockB->get(nfrzc + k, noccB + c) +
                                      l1B->get(k, c) * K_IjAb->get(ij, ab) -
                                      l2AB->get(ik, ab) * FockB->get(nfrzc + j, noccB + c) -
                                      l1B->get(j, c) * K_IjAb->get(ik, ab) -
                                      l2AB->get(ij, ac) * FockB->get(nfrzc + k, noccB + b) -
                                      l1B->get(k, b) * K_IjAb->get(ij, ac) +
                                      l2AB->get(ik, ac) * FockB->get(nfrzc + j, noccB + b) +
                                      l1B->get(j, b) * K_IjAb->get(ik, ac) +
                                      l2BB->get(kj, cb) * FockA->get(nfrzc + i, noccA + a) +
                                      l1A->get(i, a) * G_ijab->get(kj, cb);
