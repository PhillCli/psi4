...
expected_return_result = {
    "dipole": [0.0, 0.0, 1.04037263345],
    "quadrupole": [-5.42788218076, 0.0, 0.0, 0.0, -3.07521129293, 0.0, 0.0, 0.0, -4.36605314966],
    ...
    "wiberg_lowdin_indices": [
        0.0, 0.9237385044125344, 0.9237385044125329, 0.9237385044125344, 0.0, 0.006992650019441531, 0.9237385044125329,
        0.006992650019441531, 0.0
    ],
    "mayer_indices": [
        0.0, 0.802064044935596, 0.8020640449355959, 0.802064044935596, 0.0, 0.003020025778524219, 0.8020640449355959,
        0.003020025778524219, 0.0
    ]
}
...
expected_return_result["wiberg_lowdin_indices"] = np.array(expected_return_result["wiberg_lowdin_indices"]).reshape(
    (3, 3))
